...
function Q(t) {
	...
	return {
		...
		l(l) {
			e = u(l, 'H1', {});
			var h = f(e);
			(s = p(h, t[0])), h.forEach(d), (r = w(l)), (a = u(l, 'P', {}));
			var g = f(a);
			(n = p(g, i)), g.forEach(d), (o = w(l)), E && E.l(l), (c = y());
		},
		m(t, i) {
	...
	return {
		...
		h() {
			b(r, 'cx', '25'),
				b(r, 'cy', '25'),
				b(r, 'r', '25'),
				b(r, 'class', 'svelte-1471ef8'),
				b(n, 'cx', '12.5'),
				b(n, 'cy', '25'),
				b(n, 'r', '12.5'),
				b(n, 'class', 'svelte-1471ef8'),
				b(o, 'cx', '38'),
				b(o, 'cy', '25'),
				b(o, 'r', '12.5'),
				b(o, 'class', 'svelte-1471ef8'),
				b(a, 'class', 'svelte-1471ef8'),
				b(i, 'cx', '6.5'),
				b(i, 'cy', '25'),
				b(i, 'r', '6.25'),
				b(i, 'class', 'svelte-1471ef8'),
				b(l, 'cx', '19'),
				b(l, 'cy', '25'),
				b(l, 'r', '6.25'),
				b(l, 'class', 'svelte-1471ef8'),
				b(h, 'cx', '31.5'),
				b(h, 'cy', '25'),
				b(h, 'r', '6.25'),
				b(h, 'class', 'svelte-1471ef8'),
				b(p, 'cx', '44'),
				b(p, 'cy', '25'),
				b(p, 'r', '6.25'),
				b(p, 'class', 'svelte-1471ef8'),
				b(c, 'class', 'svelte-1471ef8'),
				b(s, 'class', 'svelte-1471ef8'),
				b(e, 'class', 'logo svelte-1471ef8'),
				b(e, 'width', '51'),
				b(e, 'height', '51');
		},
		m(t, u) {
...
function $t(t) {
	...
	return {
		...
		h() {
			b(e, 'class', (s = D(t[4][t[1]]) + ' svelte-lfsry1'));
		},
		m(t, s) {
			g(t, e, s);
		...
		p(t, n) {
			...
			2 & n && s !== (s = D(t[4][t[1]]) + ' svelte-lfsry1') && b(e, 'class', s);
		},
		i: x,
		o: x,
		d(t) {
...
function yt(t) {
	...
	let p = Z,
		v = [];
	for (let l = 0; l < p.length; l += 1) v[l] = xt(vt(t, p, l));
	return {
		c() {
		...
		h() {
			b(s, 'class', 'ButtonNav svelte-lfsry1'),
				b(n, 'class', (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-lfsry1')),
				b(e, 'class', 'Variante_1 svelte-lfsry1');
		},
		m(o, l) {
			...
			(c = !0),
				i ||
					((h = [B(s, 'click', t[7]), z(pt.call(null, e)), B(e, 'click_outside', t[3])]), (i = !0));
		},
		p(t, e) {
			if (9 & e) {
				let s;
...
function wt(t) {
	...
	return {
		...
		h() {
			b(e, 'href', t[9]), b(e, 'class', 'svelte-lfsry1'), I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function xt(t) {
	...
	return {
		...
		h() {
			b(e, 'href', t[9]),
				b(e, 'class', 'NavItem svelte-lfsry1'),
				b(e, 'role', 'navigation'),
				I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
class _t extends o {
	constructor(t) {
		super(), c(this, t, bt, Et, i, { current_page: 0, variante: 1 });
	}
}
function kt(t) {
	let e, s, r, a;
...
function qt(t) {
	...
	return {
		...
		h() {
			b(s, 'class', 'svelte-18yh1f7'),
				b(a, 'fill-rule', 'evenodd'),
				b(a, 'clip-rule', 'evenodd'),
				b(
					a,
					'd',
...
function St(t) {
	...
	return (
		...
		})),
		{
			...
			h() {
				b(s, 'class', 'svelte-18yh1f7'), b(e, 'class', 'Links svelte-18yh1f7');
			},
			m(t, c) {
...
function Nt(t) {
	...
	return (
		(c = new Ot({})),
		{
			...
			i(t) {
				i || (R(a.$$.fragment, t), R(p, t), R(c.$$.fragment, t), (i = !0));
			},
			o(t) {
				C(a.$$.fragment, t), C(p, t), C(c.$$.fragment, t), (i = !1);
			},
			d(t) {
...
const jt = [
		...
		() =>
			ft(() => import('./pages/philosophy/index.svelte-9483dec5.js'), [
				'/_app/pages/philosophy/index.svelte-9483dec5.js',
		...
		() =>
			ft(() => import('./pages/prototype/index.svelte-35b57bd4.js'), [
				'/_app/pages/prototype/index.svelte-35b57bd4.js',
		...
		() =>
			ft(() => import('./pages/artworks/index.svelte-70a7494b.js'), [
				'/_app/pages/artworks/index.svelte-70a7494b.js',
				'/_app/assets/pages/artworks/index.svelte-dc270452.css',
				'/_app/assets/Blockquote.svelte-35dd53bb.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-1020bc4e.js',
				'/_app/assets/Grid.svelte-57a1b800.css',
		...
		() =>
			ft(() => import('./pages/about/index.svelte-50957926.js'), [
				'/_app/pages/about/index.svelte-50957926.js',
		...
		() =>
			ft(() => import('./pages/lab/index.svelte-69024a9f.js'), [
				'/_app/pages/lab/index.svelte-69024a9f.js',
