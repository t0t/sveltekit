var t = Object.defineProperty,
	...
	n = (t, n) => {
		for (var a in n || (n = {})) e.call(n, a) && o(t, a, n[a]);
		if (r) for (var a of r(n)) s.call(n, a) && o(t, a, n[a]);
		return t;
	};
import {
	S as a,
...
function M(t) {
	...
	return {
		...
		l(c) {
			e = h(c, 'H1', {});
			var u = p(e);
			(r = d(u, t[0])), u.forEach(f), (s = b(c)), (o = h(c, 'P', {}));
			var m = p(o);
			(n = d(m, l)), m.forEach(f), (a = b(c)), _ && _.l(c), (i = v());
		},
		m(t, l) {
			m(t, e, l), g(e, r), m(t, s, l), m(t, o, l), g(o, n), m(t, a, l), _ && _.m(t, l), m(t, i, l);
		},
		p(t, [e]) {
			1 & e && $(r, t[0]),
				2 & e && l !== (l = t[1].message + '') && $(n, l),
				t[1].stack
					? _
						? _.p(t, e)
						: ((_ = D(t)), _.c(), _.m(i.parentNode, i))
					: _ && (_.d(1), (_ = null));
		},
		i: w,
		o: w,
		d(t) {
			t && f(e), t && f(s), t && f(o), t && f(a), _ && _.d(t), t && f(i);
		}
	};
}
function B(t, e, r) {
	...
	return (
		(t.$$set = (t) => {
			'status' in t && r(0, (s = t.status)), 'error' in t && r(1, (o = t.error));
		}),
		[s, o]
	);
}
class K extends a {
	constructor(t) {
		super(), i(this, t, B, M, l, { status: 0, error: 1 });
	}
}
function z(t) {
	let e, r, s;
	...
	function a(t) {
		let e = {};
		for (let r = 0; r < o.length; r += 1) e = _(e, o[r]);
		return { props: e };
	}
	return (
		n && (e = new n(a())),
		{
			...
			l(t) {
				e && q(e.$$.fragment, t), (r = v());
			},
			m(t, o) {
				e && k(e, t, o), m(t, r, o), (s = !0);
			},
			p(t, s) {
				const i = 16 & s ? R(o, [S(t[4] || {})]) : {};
				if (n !== (n = t[2][1])) {
					if (e) {
						N();
						const t = e;
					...
					n
						? ((e = new n(a())), x(e.$$.fragment), L(e.$$.fragment, 1), k(e, r.parentNode, r))
						: (e = null);
				} else n && e.$set(i);
			},
			i(t) {
...
function F(t) {
	let e, r;
	return (
		(e = new K({ props: { status: t[0], error: t[1] } })),
		{
			c() {
				x(e.$$.fragment);
			},
...
function G(t) {
	...
	return {
		...
		p(t, s) {
			t[6] ? (r ? r.p(t, s) : ((r = Y(t)), r.c(), r.m(e, null))) : r && (r.d(1), (r = null));
		},
		d(t) {
			t && f(e), r && r.d();
		}
...
function H(t) {
	let e, r, s, o;
	const n = [t[3] || {}];
	let a = { $$slots: { default: [W] }, $$scope: { ctx: t } };
	for (let l = 0; l < n.length; l += 1) a = _(a, n[l]);
	e = new t[8]({ props: a });
	let i = t[5] && G(t);
	return {
		c() {
			x(e.$$.fragment), (r = y()), i && i.c(), (s = v());
		},
		l(t) {
			q(e.$$.fragment, t), (r = b(t)), i && i.l(t), (s = v());
		},
		m(t, n) {
			k(e, t, n), m(t, r, n), i && i.m(t, n), m(t, s, n), (o = !0);
		},
		p(t, [r]) {
			const o = 8 & r ? R(n, [S(t[3] || {})]) : {};
			2071 & r && (o.$$scope = { dirty: r, ctx: t }),
				e.$set(o),
				t[5]
					? i
						? i.p(t, r)
						: ((i = G(t)), i.c(), i.m(s.parentNode, s))
					: i && (i.d(1), (i = null));
		},
		i(t) {
...
function J(t, e, r) {
	let { status: s } = e,
		...
		{ props_1: c = null } = e;
	const u = i[0];
	T('__svelte__', n), A(n.page.notify);
	let h = !1,
		p = !1,
		d = null;
	return (
		j(() => {
			const t = n.page.subscribe(() => {
				h && (r(6, (p = !0)), r(7, (d = document.title)));
			});
			return r(5, (h = !0)), t;
		}),
		(t.$$set = (t) => {
			'status' in t && r(0, (s = t.status)),
				'error' in t && r(1, (o = t.error)),
		...
		(t.$$.update = () => {
			1536 & t.$$.dirty && n.page.set(a);
		}),
		[s, o, i, l, c, h, p, d, u, n, a]
	);
}
class X extends a {
	constructor(t) {
...
const Z = {},
	tt = function (t, e) {
		...
		if (void 0 === Q) {
			...
			Q = t && t.supports && t.supports('modulepreload') ? 'modulepreload' : 'preload';
		}
		return Promise.all(
			e.map((t) => {
				if (t in Z) return;
...
function et(t) {
	...
	return {
		...
		l(t) {
			...
			r = h(c, 'A', { href: !0 });
			var u = p(r);
			(s = d(u, 'home')), u.forEach(f), (o = b(c)), (n = h(c, 'A', { href: !0 }));
			var m = p(n);
			(a = d(m, 'about')), m.forEach(f), (i = b(c)), (l = h(c, 'A', { href: !0 }));
			var g = p(l);
			($ = d(g, 'artworks')), g.forEach(f), c.forEach(f), this.h();
		},
		h() {
			E(r, 'href', '/'), E(n, 'href', '/about'), E(l, 'href', '/artworks');
		},
		m(t, c) {
			m(t, e, c), g(e, r), g(r, s), g(e, o), g(e, n), g(n, a), g(e, i), g(e, l), g(l, $);
		},
		p: w,
		i: w,
		o: w,
...
function st(t) {
	...
	return {
		...
		l(t) {
			...
			r = h(n, 'P', {});
			var a = p(r);
			(s = d(a, 'This is the default site footer')),
				a.forEach(f),
				(o = b(n)),
				i && i.l(n),
				n.forEach(f),
		...
		m(t, a) {
			m(t, e, a), g(e, r), g(r, s), g(e, o), i && i.m(e, null), (n = !0);
		},
		p(t, [e]) {
			i && i.p && 1 & e && I(i, a, t, t[0], e, null, null);
		},
		i(t) {
			n || (L(i, t), (n = !0));
		},
	...
	return (
		(a = new nt({})),
		{
			...
			l(t) {
				e = h(t, 'MAIN', {});
				var i = p(e);
				q(r.$$.fragment, i), (s = b(i)), (o = h(i, 'SECTION', {}));
				var l = p(o);
				u && u.l(l), l.forEach(f), (n = b(i)), q(a.$$.fragment, i), i.forEach(f);
			},
			m(t, l) {
				m(t, e, l),
					k(r, e, null),
			...
			p(t, [e]) {
				u && u.p && 1 & e && I(u, l, t, t[0], e, null, null);
			},
			i(t) {
				i || (L(r.$$.fragment, t), L(u, t), L(a.$$.fragment, t), (i = !0));
			},
			o(t) {
				O(r.$$.fragment, t), O(u, t), O(a.$$.fragment, t), (i = !1);
			},
			d(t) {
				t && f(e), P(r), u && u.d(t), P(a);
			}
		}
	);
}
...
var lt = Object.freeze({
	...
	default: class extends a {
		constructor(t) {
			super(), i(this, t, it, at, l, {});
		}
	}
});
const ct = [
		() =>
			tt(() => import('./pages/index.svelte-0551d093.js'), [
				'/_app/pages/index.svelte-0551d093.js',
				'/_app/assets/pages/index.svelte-253bae35.css',
				'/_app/assets/Footer.svelte-3414b7e8.css',
				'/_app/chunks/vendor-8f03db9b.js'
			]),
		() =>
			tt(() => import('./pages/artworks/index.svelte-cc3c06f2.js'), [
				'/_app/pages/artworks/index.svelte-cc3c06f2.js',
				'/_app/chunks/vendor-8f03db9b.js'
			]),
		() =>
			tt(() => import('./pages/about/index.svelte-52c277c2.js'), [
				'/_app/pages/about/index.svelte-52c277c2.js',
				'/_app/chunks/vendor-8f03db9b.js'
			])
	],
	ut = [
	...
	init(t) {
		...
		(this.renderer = t),
			...
			addEventListener('scroll', () => {
				clearTimeout(e),
					(e = setTimeout(() => {
						const t = n(n({}, history.state || {}), { 'sveltekit:scroll': ht() });
		...
		if (this.enabled) {
			...
			if (n)
				return (
					...
					this._navigate(n, e ? ht() : null, s, o.hash)
				);
		}
...
function gt(t, o) {
	const n = 'string' == typeof t ? t : t.url,
		a = document.querySelector(`script[type="svelte-data"][url="${n}"]`);
	if (a) {
		const t = JSON.parse(a.textContent),
			{ body: o } = t,
			n = ((t, o) => {
				var n = {};
				for (var a in t) e.call(t, a) && o.indexOf(a) < 0 && (n[a] = t[a]);
				if (null != t && r) for (var a of r(t)) o.indexOf(a) < 0 && s.call(t, a) && (n[a] = t[a]);
				return n;
			})(t, ['body']);
		return Promise.resolve(new Response(o, n));
	}
	return fetch(t, o);
}
class $t {
	constructor({ Root: t, layout: e, target: r, session: s, host: o }) {
		(this.Root = t),
			(this.layout = e),
			(this.host = o),
			(this.router = null),
			...
			(this.stores = { page: mt({}), navigating: V(null), session: V(s) }),
			(this.$session = null),
			(this.root = null);
		let n = !1;
	...
	async _load({ status: t, error: e, nodes: r, page: s }) {
		const o = s.query.toString(),
			a = {
				state: { page: s, query: o, session_changed: !1, nodes: [], contexts: [] },
		...
		try {
			...
			for (let r = 0; r < t.length; r += 1) {
				const u = this.current.nodes[r],
					...
					p = await t[r];
				if (((a.props.components[r] = p.default), p.preload))
					throw new Error(
					...
					if (m) {
						...
						if ((m.context && ((i.context = !0), (c = n(n({}, c), m.context))), m.maxage)) {
							...
							const s = setTimeout(() => {
								...
								o = () => {
									t.get(u) === e && t.delete(u), n(), clearTimeout(s);
								},
...
async function yt({ paths: t, target: e, session: r, host: s, route: o, hydrate: n }) {
	const a = o && new dt({ base: t.base, routes: ut }),
		i = new $t({ Root: X, layout: lt, target: e, session: r, host: s });
	n && (await i.start(n)), o && a.init(i), dispatchEvent(new CustomEvent('sveltekit:start'));
}
export { yt as start };
