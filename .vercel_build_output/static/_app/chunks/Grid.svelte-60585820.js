...
function _(t) {
	...
	return {
		...
		l(i) {
			...
			var a = h(e);
			(s = p(a, t[0])), a.forEach(r), this.h();
		},
		h() {
			g(e, 'class', (i = m(t[6][t[4]]) + ' svelte-1l8uz2h')), d(e, 'not-clickable', '' == t[5]);
		},
		m(i, r) {
		...
		p(t, a) {
			1 & a && v(s, t[0]),
				16 & a && i !== (i = m(t[6][t[4]]) + ' svelte-1l8uz2h') && g(e, 'class', i),
...
function B(t) {
	...
	return {
		...
		h() {
			g(e, 'type', 'submit'), g(e, 'class', (i = m(t[6][t[4]]) + ' svelte-1l8uz2h'));
		},
		m(i, r) {
...
function z(t) {
	...
	return {
		...
		h() {
			g(e, 'class', (i = 'button ' + t[6][t[4]] + ' svelte-1l8uz2h')), g(e, 'href', t[1]);
		},
		m(t, i) {
			a(t, e, i), b(e, s);
		},
		p(t, a) {
			1 & a && v(s, t[0]),
				16 & a && i !== (i = 'button ' + t[6][t[4]] + ' svelte-1l8uz2h') && g(e, 'class', i),
				2 & a && g(e, 'href', t[1]);
		},
		d(t) {
			t && r(e);
...
function j(t) {
	...
	return {
		...
		h() {
			g(e, 'class', (i = 'button ' + t[6][t[4]] + ' svelte-1l8uz2h')),
				g(e, 'href', t[1]),
				g(e, 'target', t[3]);
		},
		m(t, i) {
