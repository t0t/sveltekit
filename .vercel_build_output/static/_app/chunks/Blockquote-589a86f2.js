...
function w(s) {
	...
	return {
		c() {
			(t = l('blockquote')), O && O.c(), (a = c()), Q && Q.c(), this.h();
		},
		l(s) {
		...
		h() {
			u(t, 'class', (w = s[2][s[1]] + '  svelte-1a0wh7t'));
		},
		m(s, e) {
			h(s, t, e), O && O.m(t, null), p(t, a), Q && Q.m(t, null), (B = !0);
		},
		p(s, [a]) {
			E ? E.p && 8 & a && d(E, b, s, s[3], a, null, null) : O && O.p && 1 & a && O.p(s, a),
				Q && Q.p && 8 & a && d(Q, j, s, s[3], a, q, k),
				(!B || (2 & a && w !== (w = s[2][s[1]] + '  svelte-1a0wh7t'))) && u(t, 'class', w);
		},
		i(s) {
			B || ($(O, s), $(Q, s), (B = !0));
		},
...
class b extends s {
	constructor(s) {
		super(), t(this, s, B, w, a, { text: 0, variante: 1 });
	}
}
export { b as B };
