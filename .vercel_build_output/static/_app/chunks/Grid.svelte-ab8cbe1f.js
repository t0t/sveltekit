...
function _(t) {
	...
	return {
		...
		h() {
			p(e, 'class', (i = g(t[6][t[4]]) + ' svelte-18uls8m')), d(e, 'not-clickable', '' == t[5]);
		},
		m(i, r) {
		...
		p(t, a) {
			1 & a && v(s, t[0]),
				16 & a && i !== (i = g(t[6][t[4]]) + ' svelte-18uls8m') && p(e, 'class', i),
...
function B(t) {
	...
	return {
		...
		h() {
			p(e, 'type', 'submit'), p(e, 'class', (i = g(t[6][t[4]]) + ' svelte-18uls8m'));
		},
		m(i, r) {
...
function j(t) {
	...
	return {
		...
		h() {
			p(e, 'class', (i = 'button ' + t[6][t[4]] + ' svelte-18uls8m')), p(e, 'href', t[1]);
		},
		m(t, i) {
			a(t, e, i), b(e, s);
		},
		p(t, a) {
			1 & a && v(s, t[0]),
				16 & a && i !== (i = 'button ' + t[6][t[4]] + ' svelte-18uls8m') && p(e, 'class', i),
				2 & a && p(e, 'href', t[1]);
		},
		d(t) {
			t && r(e);
...
function k(t) {
	...
	return {
		...
		h() {
			p(e, 'class', (i = 'button ' + t[6][t[4]] + ' svelte-18uls8m')),
				p(e, 'href', t[1]),
				p(e, 'target', t[3]);
		},
		m(t, i) {
