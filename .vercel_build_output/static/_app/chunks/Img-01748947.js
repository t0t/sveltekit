...
function p(s) {
	...
	return {
		c() {
			(a = n('figure')), (e = n('img')), (c = i()), (x = n('figcaption')), (p = f(s[1])), this.h();
		},
		l(t) {
		...
		h() {
			e.src !== (t = s[0]) && g(e, 'src', t),
				g(e, 'alt', s[1]),
				g(e, 'href', s[2]),
				g(e, 'class', 'svelte-13sxf7s'),
				g(x, 'class', 'alt svelte-13sxf7s'),
				g(a, 'class', (_ = d(s[4][s[3]]) + ' svelte-13sxf7s'));
		},
		m(s, t) {
		...
		p(s, r) {
			1 & r && e.src !== (t = s[0]) && g(e, 'src', t),
				...
				4 & r && g(e, 'href', s[2]),
				2 & r && I(p, s[1]),
				8 & r && _ !== (_ = d(s[4][s[3]]) + ' svelte-13sxf7s') && g(a, 'class', _);
		},
		d(s) {
			s && l(a);
		}
	...
	return {
		...
		h() {
			a.src !== (e = s[0]) && g(a, 'src', e),
				g(a, 'alt', s[1]),
				g(a, 'href', s[2]),
				g(a, 'class', (t = d(s[4][s[3]]) + ' svelte-13sxf7s'));
		},
		m(s, e) {
			r(s, a, e);
		},
		p(s, r) {
			1 & r && a.src !== (e = s[0]) && g(a, 'src', e),
				2 & r && g(a, 'alt', s[1]),
				4 & r && g(a, 'href', s[2]),
				8 & r && t !== (t = d(s[4][s[3]]) + ' svelte-13sxf7s') && g(a, 'class', t);
		},
		d(s) {
			s && l(a);
		}
...
function E(s) {
	...
	return {
		...
		h() {
			g(a, 'class', (e = d(s[4][s[3]]) + ' svelte-13sxf7s')),
		...
		p(s, t) {
			8 & t && e !== (e = d(s[4][s[3]]) + ' svelte-13sxf7s') && g(a, 'class', e),
