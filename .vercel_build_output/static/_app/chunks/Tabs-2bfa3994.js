...
import { G as C, B as I } from './GridBase-a41c03d9.js';
import { L, a as S } from './ListItem-8591f839.js';
/* empty css                    */ const k = [
	{
		id: 0,
		title: 'Historia',
...
function T(e) {
	let t, a, o, m, p;
	return (
		(a = new I({ props: { variante: 8, text: e[3].title } })),
		a.$on('click', function () {
			j(e[2](e[3].id)) && e[2](e[3].id).apply(this, arguments);
		}),
		{
			c() {
			...
			h() {
				x(t, 'class', (o = w(e[1] === e[3].id ? 'active' : '') + ' svelte-1z7pek'));
			},
			m(e, o) {
			...
			p(n, s) {
				...
				1 & s && (i.text = e[3].title),
					a.$set(i),
					(!p || (3 & s && o !== (o = w(e[1] === e[3].id ? 'active' : '') + ' svelte-1z7pek'))) &&
						x(t, 'class', o);
			},
			i(e) {
...
function H(e) {
	let t, a;
	return (
		(t = new S({ props: { tipo: 1, $$slots: { default: [T] }, $$scope: { ctx: e } } })),
		{
			c() {
				i(t.$$.fragment);
			},
...
function B(e) {
	let t,
		...
		i = e[0],
		r = [];
	for (let o = 0; o < i.length; o += 1) r[o] = H(N(e, i, o));
	const l = (e) =>
		c(r[e], 1, 1, () => {
			r[e] = null;
		});
		...
		p(e, a) {
			if (7 & a) {
				...
				for (i = e[0], o = 0; o < i.length; o += 1) {
					...
					r[o]
						? (r[o].p(n, a), s(r[o], 1))
						: ((r[o] = H(n)), r[o].c(), s(r[o], 1), r[o].m(t.parentNode, t));
				}
...
function V(e) {
	...
	return {
		...
		l(e) {
			...
			var n = b(r);
			(l = z(n, c)), n.forEach(u), o.forEach(u), this.h();
		},
		h() {
			a.src !== (o = e[3].img) && x(a, 'src', o),
				x(a, 'alt', (s = e[3].subtitle)),
				x(a, 'class', 'svelte-1z7pek'),
				x(r, 'class', 'svelte-1z7pek'),
				x(t, 'slot', 'subarea1'),
				x(t, 'class', 'svelte-1z7pek');
		},
		m(e, o) {
			n(e, t, o), q(t, a), q(t, i), q(t, r), q(r, l);
		},
		p(e, t) {
			1 & t && a.src !== (o = e[3].img) && x(a, 'src', o),
				1 & t && s !== (s = e[3].subtitle) && x(a, 'alt', s),
				1 & t && c !== (c = e[3].subtitle + '') && E(l, c);
		},
		d(e) {
			e && u(t);
		}
...
function J(e) {
	let t,
		...
		i = e[3].tags,
		r = [];
	for (let o = 0; o < i.length; o += 1) r[o] = F(P(e, i, o));
	const l = (e) =>
		c(r[e], 1, 1, () => {
			r[e] = null;
		});
...
function R(e) {
	...
	return (
		...
		})),
		{
			...
			h() {
				x(t, 'slot', 'subarea2'), x(t, 'class', 'svelte-1z7pek');
			},
			m(e, s) {
...
function U(e) {
	...
	return (
		(t = new C({
			props: {
				variante: 3,
				$$slots: { subarea2: [R], subarea1: [V], default: [M] },
				$$scope: { ctx: e }
			}
		})),
		{
	...
	return {
		...
		p(e, a) {
			e[1] == e[3].id
				? i
					? (i.p(e, a), 3 & a && s(i, 1))
					: ((i = G(e)), i.c(), s(i, 1), i.m(t.parentNode, t))
				: i &&
				  (m(),
				  c(i, 1, 1, () => {
						i = null;
...
function K(e) {
	let t, a, h, v;
	t = new L({ props: { tipo: 3, variante: 3, $$slots: { default: [B] }, $$scope: { ctx: e } } });
	let b = e[0],
		x = [];
	for (let o = 0; o < b.length; o += 1) x[o] = O(A(e, b, o));
	const y = (e) =>
		c(x[e], 1, 1, () => {
			x[e] = null;
		});
