...
function b(s) {
	...
	return {
		...
		l(t) {
			...
			var n = u(I);
			(b = o(n, s[1])), n.forEach(l), r.forEach(l), this.h();
		},
		h() {
			e.src !== (t = s[0]) && m(e, 'src', t),
				m(e, 'alt', s[1]),
				m(e, 'href', s[2]),
				m(e, 'class', 'svelte-gbpfu8'),
				m(I, 'class', 'alt svelte-gbpfu8'),
				m(a, 'class', (_ = p(s[4][s[3]]) + ' svelte-gbpfu8'));
		},
		m(s, t) {
		...
		p(s, r) {
			1 & r && e.src !== (t = s[0]) && m(e, 'src', t),
				...
				4 & r && m(e, 'href', s[2]),
				2 & r && v(b, s[1]),
				8 & r && _ !== (_ = p(s[4][s[3]]) + ' svelte-gbpfu8') && m(a, 'class', _);
		},
		d(s) {
			s && l(a);
		}
	...
	return {
		...
		h() {
			a.src !== (e = s[0]) && m(a, 'src', e),
				m(a, 'alt', s[1]),
				m(a, 'href', s[2]),
				m(a, 'class', (t = p(s[4][s[3]]) + ' svelte-gbpfu8'));
		},
		m(s, e) {
			r(s, a, e);
		},
		p(s, r) {
			1 & r && a.src !== (e = s[0]) && m(a, 'src', e),
				2 & r && m(a, 'alt', s[1]),
				4 & r && m(a, 'href', s[2]),
				8 & r && t !== (t = p(s[4][s[3]]) + ' svelte-gbpfu8') && m(a, 'class', t);
		},
		d(s) {
			s && l(a);
		}
...
function E(s) {
	...
	return {
		...
		h() {
			m(a, 'class', (e = p(s[4][s[3]]) + ' svelte-gbpfu8')),
		...
		p(s, t) {
			8 & t && e !== (e = p(s[4][s[3]]) + ' svelte-gbpfu8') && m(a, 'class', e),
