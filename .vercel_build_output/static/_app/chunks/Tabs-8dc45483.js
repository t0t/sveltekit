...
import { G as q } from './Grid-11b84c17.js';
import { L as w, a as C } from './ListItem-91cb1752.js';
import { B as E } from './Grid.svelte-81f2d089.js';
import { I as L } from './Img-8391a33a.js';
/* empty css                    */ const S = [
	{
		id: 0,
		title: 'Historia',
...
function I(e) {
	...
	return (
		...
		a.$on('click', function () {
			y(e[2](e[3].id)) && e[2](e[3].id).apply(this, arguments);
		}),
		{
			c() {
			...
			h() {
				x(t, 'class', (o = j(e[1] === e[3].id ? 'active' : '') + ' svelte-ckb0wt'));
			},
			m(e, o) {
			...
			p(n, s) {
				...
				1 & s && (i.text = e[3].title),
					a.$set(i),
					(!p || (3 & s && o !== (o = j(e[1] === e[3].id ? 'active' : '') + ' svelte-ckb0wt'))) &&
						x(t, 'class', o);
			},
			i(e) {
...
function M(e) {
	...
	let b = e[0],
		x = [];
	for (let o = 0; o < b.length; o += 1) x[o] = G(z(e, b, o));
	const y = (e) =>
		c(x[e], 1, 1, () => {
			x[e] = null;
		});
		...
		p(e, [a]) {
			...
			if ((259 & a && (o.$$scope = { dirty: a, ctx: e }), t.$set(o), 3 & a)) {
				...
				for (b = e[0], t = 0; t < b.length; t += 1) {
					...
					x[t]
						? (x[t].p(o, a), s(x[t], 1))
						: ((x[t] = G(o)), x[t].c(), s(x[t], 1), x[t].m(h.parentNode, h));
				}
