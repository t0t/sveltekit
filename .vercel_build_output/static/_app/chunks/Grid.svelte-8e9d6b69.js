...
function k(t) {
	...
	return {
		...
		h() {
			g(e, 'class', (i = m(t[6][t[4]]) + ' svelte-1k927pj')), d(e, 'not-clickable', '' == t[5]);
		},
		m(i, r) {
		...
		p(t, a) {
			1 & a && v(s, t[0]),
				16 & a && i !== (i = m(t[6][t[4]]) + ' svelte-1k927pj') && g(e, 'class', i),
...
function x(t) {
	...
	return {
		...
		h() {
			g(e, 'type', 'submit'), g(e, 'class', (i = m(t[6][t[4]]) + ' svelte-1k927pj'));
		},
		m(i, r) {
...
function _(t) {
	...
	return {
		...
		h() {
			g(e, 'class', (i = 'button ' + t[6][t[4]] + ' svelte-1k927pj')), g(e, 'href', t[1]);
		},
		m(t, i) {
			a(t, e, i), b(e, s);
		},
		p(t, a) {
			1 & a && v(s, t[0]),
				16 & a && i !== (i = 'button ' + t[6][t[4]] + ' svelte-1k927pj') && g(e, 'class', i),
				2 & a && g(e, 'href', t[1]);
		},
		d(t) {
			t && r(e);
...
function B(t) {
	...
	return {
		...
		h() {
			g(e, 'class', (i = 'button ' + t[6][t[4]] + ' svelte-1k927pj')),
				g(e, 'href', t[1]),
				g(e, 'target', t[3]);
		},
		m(t, i) {
...
function y(t) {
	let e;
	function s(t, e) {
		return t[3] ? B : !t[3] && t[1] ? _ : t[2] ? x : k;
	}
	let o = s(t),
		l = o(t);
	return {
