...
import { L as W, a as J } from './chunks/ListItem-ea6efde4.js';
...
function Q(t) {
	...
	return {
		...
		l(l) {
			...
			var m = p(a);
			(n = f(m, c)), m.forEach(d), (o = w(l)), E && E.l(l), (i = y());
		},
		m(t, c) {
			m(t, e, c), g(e, s), m(t, r, c), m(t, a, c), g(a, n), m(t, o, c), E && E.m(t, c), m(t, i, c);
		},
		p(t, [e]) {
			1 & e && v(s, t[0]),
				2 & e && c !== (c = t[1].message + '') && v(n, c),
				t[1].stack
					? E
						? E.p(t, e)
						: ((E = X(t)), E.c(), E.m(i.parentNode, i))
					: E && (E.d(1), (E = null));
		},
		i: x,
		o: x,
		d(t) {
			t && d(e), t && d(r), t && d(a), t && d(o), E && E.d(t), t && d(i);
		}
	};
}
function tt(t, e, s) {
...
class et extends o {
	constructor(t) {
		super(), i(this, t, tt, Q, c, { status: 0, error: 1 });
	}
}
function st(t) {
	let e, s, r;
...
function it(t) {
	...
	return {
		c() {
			b(e.$$.fragment), (s = $()), i && i.c(), (r = y());
		},
		l(t) {
			k(e.$$.fragment, t), (s = w(t)), i && i.l(t), (r = y());
		},
		m(t, n) {
			L(e, t, n), m(t, s, n), i && i.m(t, n), m(t, r, n), (a = !0);
		},
		p(t, [s]) {
	...
	return {
		...
		h() {
			_(r, 'cx', '25'),
				_(r, 'cy', '25'),
				_(r, 'r', '25'),
				_(r, 'class', 'svelte-3203ok'),
				_(n, 'cx', '12.5'),
				_(n, 'cy', '25'),
				_(n, 'r', '12.5'),
				_(n, 'class', 'svelte-3203ok'),
				_(o, 'cx', '38'),
				_(o, 'cy', '25'),
				_(o, 'r', '12.5'),
				_(o, 'class', 'svelte-3203ok'),
				_(a, 'class', 'svelte-3203ok'),
				_(c, 'cx', '6.5'),
				_(c, 'cy', '25'),
				_(c, 'r', '6.25'),
				_(c, 'class', 'svelte-3203ok'),
				_(l, 'cx', '19'),
				_(l, 'cy', '25'),
				_(l, 'r', '6.25'),
				_(l, 'class', 'svelte-3203ok'),
				_(h, 'cx', '31.5'),
				_(h, 'cy', '25'),
				_(h, 'r', '6.25'),
				_(h, 'class', 'svelte-3203ok'),
				_(f, 'cx', '44'),
				_(f, 'cy', '25'),
				_(f, 'r', '6.25'),
				_(f, 'class', 'svelte-3203ok'),
				_(i, 'class', 'svelte-3203ok'),
				_(s, 'class', 'svelte-3203ok'),
				_(e, 'class', 'logo svelte-3203ok'),
				_(e, 'width', '51'),
				_(e, 'height', '51');
		},
		m(t, u) {
...
function $t(t) {
	...
	return {
		...
		h() {
			_(e, 'class', (s = D(t[4][t[1]]) + ' svelte-1kl3n2v'));
		},
		m(t, s) {
			m(t, e, s);
		...
		p(t, n) {
			...
			2 & n && s !== (s = D(t[4][t[1]]) + ' svelte-1kl3n2v') && _(e, 'class', s);
		},
		i: x,
		o: x,
		d(t) {
...
function yt(t) {
	...
	return {
		c() {
			(e = l('div')), (s = l('div')), b(r.$$.fragment), (a = $()), (n = l('nav'));
		...
		l(t) {
			...
			s = u(o, 'DIV', { class: !0 });
			var i = p(s);
			k(r.$$.fragment, i), i.forEach(d), (a = w(o)), (n = u(o, 'NAV', { class: !0 }));
			var c = p(n);
			for (let e = 0; e < v.length; e += 1) v[e].l(c);
			c.forEach(d), o.forEach(d), this.h();
		},
		h() {
			_(s, 'class', 'ButtonNav svelte-1kl3n2v'),
				_(n, 'class', (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-1kl3n2v')),
				_(e, 'class', 'Variante_1 svelte-1kl3n2v');
		},
		m(o, l) {
			m(o, e, l), g(e, s), L(r, s, null), g(e, a), g(e, n);
			for (let t = 0; t < v.length; t += 1) v[t].m(n, null);
			(i = !0),
				c ||
					((h = [B(s, 'click', t[7]), z(ft.call(null, e)), B(e, 'click_outside', t[3])]), (c = !0));
		},
		p(t, e) {
			if (9 & e) {
				let s;
			...
			(!i ||
				(4 & e &&
					o !== (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-1kl3n2v'))) &&
				_(n, 'class', o);
		},
		i(t) {
			i || (R(r.$$.fragment, t), (i = !0));
		},
		o(t) {
			C(r.$$.fragment, t), (i = !1);
		},
		d(t) {
			t && d(e), S(r), H(v, t), (c = !1), U(h);
		}
	};
}
function wt(t) {
	...
	return {
		...
		h() {
			_(e, 'href', t[9]), _(e, 'class', 'svelte-1kl3n2v'), I(e, 'active', t[10] === t[0]);
		},
		m(o, i) {
			m(o, e, i), g(e, s), g(e, r), a || ((n = B(e, 'click', t[6])), (a = !0));
		},
		p(t, s) {
...
function xt(t) {
	...
	return {
		...
		h() {
			_(e, 'href', t[9]),
				_(e, 'class', 'NavItem svelte-1kl3n2v'),
				_(e, 'role', 'navigation'),
				I(e, 'active', t[10] === t[0]);
		},
		m(o, i) {
	...
	return (
		...
		})),
		{
			...
			p(t, s) {
				...
				const c = {};
				1 & s && (c.$$scope = { dirty: s, ctx: t }), n.$set(c);
				const h = {};
				1 & s && (h.$$scope = { dirty: s, ctx: t }), i.$set(h);
				const u = {};
			...
			d(t) {
				S(e, t), t && d(s), S(r, t), t && d(a), S(n, t), t && d(o), S(i, t), t && d(c), S(l, t);
			}
		}
	);
}
function St(t) {
	...
	return (
		...
		})),
		{
			...
			h() {
				_(s, 'class', 'svelte-1viem25'), _(e, 'class', 'Links svelte-1viem25');
			},
			m(t, i) {
				m(t, e, i), g(e, s), g(s, r), g(e, a), L(n, e, null), (o = !0);
			},
			p(t, [e]) {
				const s = {};
...
function Mt(t) {
	...
	return (
		...
		{
			c() {
				(e = l('footer')), b(s.$$.fragment), this.h();
			},
			l(t) {
		...
		(i = new Ot({})),
		{
			...
			l(t) {
				F('[data-svelte="svelte-1ygbxhz"]', document.head).forEach(d),
					...
					(r = u(t, 'MAIN', {}));
				var e = p(r);
				k(a.$$.fragment, e), (n = w(e)), f && f.l(e), (o = w(e)), k(i.$$.fragment, e), e.forEach(d);
			},
			m(t, e) {
				m(t, s, e),
					m(t, r, e),
			...
			i(t) {
				c || (R(a.$$.fragment, t), R(f, t), R(i.$$.fragment, t), (c = !0));
			},
			o(t) {
				C(a.$$.fragment, t), C(f, t), C(i.$$.fragment, t), (c = !1);
			},
			d(t) {
				t && d(s), t && d(r), S(a), f && f.d(t), S(i);
			}
		}
	);
}
...
var Tt = Object.freeze({
	...
	default: class extends o {
		constructor(t) {
			super(), i(this, t, Pt, Nt, c, {});
		}
	}
});
const jt = [
		() =>
			pt(() => import('./pages/index.svelte-e781df09.js'), [
				'/_app/pages/index.svelte-e781df09.js',
				'/_app/assets/pages/index.svelte-6a423eaf.css',
				'/_app/assets/Blockquote.svelte-e735ba13.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-e568fec9.js',
				'/_app/assets/Grid.svelte-f06d9ce4.css',
				'/_app/chunks/Header-72a33ab9.js',
				'/_app/assets/Header-97570cc9.css',
				'/_app/chunks/pages-cee8d843.js',
				'/_app/chunks/ListItem-ea6efde4.js',
				'/_app/assets/ListItem-6c77ea47.css',
				'/_app/chunks/Blockquote-dc6b88ca.js',
				'/_app/chunks/index-65311448.js',
				'/_app/chunks/index-78b22dae.js',
				'/_app/chunks/Img-d7035d09.js',
				'/_app/assets/Img-9d4a18ad.css'
			]),
		() =>
			pt(() => import('./pages/philosophy/index.svelte-67602450.js'), [
				'/_app/pages/philosophy/index.svelte-67602450.js',
				'/_app/assets/pages/philosophy/index.svelte-e07b1dea.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-e568fec9.js',
				'/_app/assets/Grid.svelte-f06d9ce4.css',
				'/_app/chunks/Header-72a33ab9.js',
				...
				'/_app/chunks/Section-2abcbe78.js',
				'/_app/chunks/Tabs-b86573a7.js',
				'/_app/assets/Tabs-88d0fcad.css',
				'/_app/chunks/ListItem-ea6efde4.js',
				'/_app/assets/ListItem-6c77ea47.css',
				'/_app/chunks/Img-d7035d09.js',
				'/_app/assets/Img-9d4a18ad.css'
		...
		() =>
			pt(() => import('./pages/prototype/index.svelte-eea5e852.js'), [
				'/_app/pages/prototype/index.svelte-eea5e852.js',
				'/_app/assets/pages/prototype/index.svelte-d87ccb9d.css',
				'/_app/assets/Blockquote.svelte-e735ba13.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-e568fec9.js',
				'/_app/assets/Grid.svelte-f06d9ce4.css',
		...
		() =>
			pt(() => import('./pages/artworks/index.svelte-4863da48.js'), [
				'/_app/pages/artworks/index.svelte-4863da48.js',
				'/_app/assets/pages/artworks/index.svelte-56700025.css',
				'/_app/assets/Blockquote.svelte-e735ba13.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-e568fec9.js',
				'/_app/assets/Grid.svelte-f06d9ce4.css',
		...
		() =>
			pt(() => import('./pages/about/index.svelte-ddc119bb.js'), [
				'/_app/pages/about/index.svelte-ddc119bb.js',
				'/_app/assets/pages/about/index.svelte-11bae82b.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Section-2abcbe78.js',
				'/_app/chunks/Header-72a33ab9.js',
				'/_app/assets/Header-97570cc9.css',
		...
		() =>
			pt(() => import('./pages/lab/index.svelte-8b41995d.js'), [
				'/_app/pages/lab/index.svelte-8b41995d.js',
				'/_app/assets/pages/lab/index.svelte-2ed9e1ee.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-e568fec9.js',
				'/_app/assets/Grid.svelte-f06d9ce4.css',
				'/_app/chunks/Header-72a33ab9.js',
			...
			for (let s = 0; s < t.length; s += 1) {
				...
				if (
					...
					if (m) {
						...
						if ((m.context && ((i.context = !0), (l = n(n({}, l), m.context))), m.maxage)) {
...
async function Gt({ paths: t, target: e, session: s, host: r, route: a, hydrate: n }) {
	const o = a && new Ht({ base: t.base, routes: It }),
		i = new Ft({ Root: lt, layout: Tt, target: e, session: s, host: r });
