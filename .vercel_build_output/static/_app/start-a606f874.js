...
import { w as z } from './chunks/index-ca4d1474.js';
function B(t) {
	let e,
		r,
		s = t[1].stack + '';
...
function W(t) {
	...
	return {
		...
		l(c) {
			e = h(c, 'H1', {});
			var u = p(e);
			(r = d(u, t[0])), u.forEach(f), (s = b(c)), (n = h(c, 'P', {}));
			var m = p(n);
			(o = d(m, l)), m.forEach(f), (a = b(c)), _ && _.l(c), (i = $());
		},
		m(t, l) {
...
function ht(t) {
	...
	let d = lt,
		y = [];
	for (let c = 0; c < d.length; c += 1) y[c] = ut(ct(t, d, c));
	const $ = t[3].default,
		w = I($, t, t[2], null);
	return (
		(l = new it({})),
...
var dt = Object.freeze({
	...
	default: class extends a {
		constructor(t) {
			super(), i(this, t, pt, ht, l, {});
		}
	}
});
const ft = [
		() =>
			nt(() => import('./pages/index.svelte-f93b544a.js'), [
				'/_app/pages/index.svelte-f93b544a.js',
				'/_app/assets/pages/index.svelte-8a8b585e.css',
				'/_app/chunks/vendor-02401848.js',
				'/_app/chunks/FlipCard-594c53eb.js',
				'/_app/assets/FlipCard-7018c46f.css',
				'/_app/chunks/index-ca4d1474.js',
				'/_app/chunks/Section-d4b14a01.js',
				'/_app/assets/Section-95823de1.css'
			]),
		() =>
			nt(() => import('./pages/artworks/index.svelte-ff9b157c.js'), [
				'/_app/pages/artworks/index.svelte-ff9b157c.js',
				'/_app/chunks/vendor-02401848.js',
				'/_app/chunks/FlipCard-594c53eb.js',
				'/_app/assets/FlipCard-7018c46f.css'
			]),
		() =>
			nt(() => import('./pages/about/index.svelte-24e5b52c.js'), [
				'/_app/pages/about/index.svelte-24e5b52c.js',
				'/_app/assets/pages/about/index.svelte-911f19d7.css',
				'/_app/chunks/vendor-02401848.js',
				'/_app/chunks/Section-d4b14a01.js',
				'/_app/assets/Section-95823de1.css'
			])
...
async function Et({ paths: t, target: e, session: r, host: s, route: n, hydrate: o }) {
	const a = n && new vt({ base: t.base, routes: mt }),
		i = new _t({ Root: et, layout: dt, target: e, session: r, host: s });
