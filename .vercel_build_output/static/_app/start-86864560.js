...
import { L as W, a as J } from './chunks/ListItem-dc89416a.js';
...
function Q(t) {
	...
	return {
		...
		l(l) {
			...
			var m = p(a);
			(n = f(m, i)), m.forEach(d), (o = w(l)), E && E.l(l), (c = y());
		},
		m(t, i) {
			m(t, e, i), g(e, s), m(t, r, i), m(t, a, i), g(a, n), m(t, o, i), E && E.m(t, i), m(t, c, i);
		},
		p(t, [e]) {
			1 & e && v(s, t[0]),
	...
	return {
		...
		h() {
			_(r, 'cx', '25'),
				_(r, 'cy', '25'),
				_(r, 'r', '25'),
				_(r, 'class', 'svelte-14577c9'),
				_(n, 'cx', '12.5'),
				_(n, 'cy', '25'),
				_(n, 'r', '12.5'),
				_(n, 'class', 'svelte-14577c9'),
				_(o, 'cx', '38'),
				_(o, 'cy', '25'),
				_(o, 'r', '12.5'),
				_(o, 'class', 'svelte-14577c9'),
				_(a, 'class', 'svelte-14577c9'),
				_(i, 'cx', '6.5'),
				_(i, 'cy', '25'),
				_(i, 'r', '6.25'),
				_(i, 'class', 'svelte-14577c9'),
				_(l, 'cx', '19'),
				_(l, 'cy', '25'),
				_(l, 'r', '6.25'),
				_(l, 'class', 'svelte-14577c9'),
				_(h, 'cx', '31.5'),
				_(h, 'cy', '25'),
				_(h, 'r', '6.25'),
				_(h, 'class', 'svelte-14577c9'),
				_(f, 'cx', '44'),
				_(f, 'cy', '25'),
				_(f, 'r', '6.25'),
				_(f, 'class', 'svelte-14577c9'),
				_(c, 'class', 'svelte-14577c9'),
				_(s, 'class', 'svelte-14577c9'),
				_(e, 'class', 'logo svelte-14577c9'),
				_(e, 'width', '51'),
				_(e, 'height', '51');
		},
		m(t, u) {
...
function $t(t) {
	...
	return {
		...
		h() {
			_(e, 'class', (s = D(t[4][t[1]]) + ' svelte-oi10sw'));
		},
		m(t, s) {
			m(t, e, s);
		...
		p(t, n) {
			...
			2 & n && s !== (s = D(t[4][t[1]]) + ' svelte-oi10sw') && _(e, 'class', s);
		},
		i: x,
		o: x,
		d(t) {
...
function yt(t) {
	...
	return {
		...
		h() {
			_(s, 'class', 'ButtonNav svelte-oi10sw'),
				_(n, 'class', (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-oi10sw')),
				_(e, 'class', 'Variante_1 svelte-oi10sw');
		},
		m(o, l) {
		...
		p(t, e) {
			...
			(!c ||
				(4 & e && o !== (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-oi10sw'))) &&
				_(n, 'class', o);
		},
		i(t) {
...
function wt(t) {
	...
	return {
		...
		h() {
			_(e, 'href', t[9]), _(e, 'class', 'svelte-oi10sw'), I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function xt(t) {
	...
	return {
		...
		h() {
			_(e, 'href', t[9]),
				_(e, 'class', 'NavItem svelte-oi10sw'),
				_(e, 'role', 'navigation'),
				I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function St(t) {
	...
	return (
		...
		})),
		{
			...
			h() {
				_(s, 'class', 'svelte-1fmseyu'), _(e, 'class', 'Links svelte-1fmseyu');
			},
			m(t, c) {
...
const jt = [
		() =>
			pt(() => import('./pages/index.svelte-9c4aaaf0.js'), [
				'/_app/pages/index.svelte-9c4aaaf0.js',
				'/_app/assets/pages/index.svelte-29a0e0f1.css',
				'/_app/assets/Blockquote.svelte-82df4e43.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-ab8cbe1f.js',
				'/_app/assets/Grid.svelte-5aca1e87.css',
				'/_app/chunks/Header-bff7bbb7.js',
				'/_app/assets/Header-38f5f8dc.css',
				'/_app/chunks/pages-cee8d843.js',
				'/_app/chunks/ListItem-dc89416a.js',
				'/_app/assets/ListItem-d62b94db.css',
				'/_app/chunks/Blockquote-93fb4812.js',
				'/_app/chunks/index-65311448.js',
				'/_app/chunks/index-78b22dae.js',
				'/_app/chunks/Img-76e74fb8.js',
				'/_app/assets/Img-25f2b4c5.css'
			]),
		() =>
			pt(() => import('./pages/philosophy/index.svelte-cd1e08b9.js'), [
				'/_app/pages/philosophy/index.svelte-cd1e08b9.js',
				'/_app/assets/pages/philosophy/index.svelte-ac9b0b1e.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-ab8cbe1f.js',
				'/_app/assets/Grid.svelte-5aca1e87.css',
				'/_app/chunks/Header-bff7bbb7.js',
				...
				'/_app/chunks/Section-b98eefba.js',
				'/_app/chunks/Tabs-3fc136cf.js',
				'/_app/assets/Tabs-3c48cbfb.css',
				'/_app/chunks/ListItem-dc89416a.js',
				'/_app/assets/ListItem-d62b94db.css',
				'/_app/chunks/Img-76e74fb8.js',
				'/_app/assets/Img-25f2b4c5.css'
		...
		() =>
			pt(() => import('./pages/prototype/index.svelte-7a53a4a3.js'), [
				'/_app/pages/prototype/index.svelte-7a53a4a3.js',
				'/_app/assets/pages/prototype/index.svelte-f72f7c10.css',
				'/_app/assets/Blockquote.svelte-82df4e43.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-ab8cbe1f.js',
				'/_app/assets/Grid.svelte-5aca1e87.css',
		...
		() =>
			pt(() => import('./pages/artworks/index.svelte-87584613.js'), [
				'/_app/pages/artworks/index.svelte-87584613.js',
				'/_app/assets/pages/artworks/index.svelte-2cbf0a28.css',
				'/_app/assets/Blockquote.svelte-82df4e43.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-ab8cbe1f.js',
				'/_app/assets/Grid.svelte-5aca1e87.css',
		...
		() =>
			pt(() => import('./pages/about/index.svelte-c8562417.js'), [
				'/_app/pages/about/index.svelte-c8562417.js',
				'/_app/assets/pages/about/index.svelte-6af7f525.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Section-b98eefba.js',
				'/_app/chunks/Header-bff7bbb7.js',
				'/_app/assets/Header-38f5f8dc.css',
		...
		() =>
			pt(() => import('./pages/lab/index.svelte-cf07c0d4.js'), [
				'/_app/pages/lab/index.svelte-cf07c0d4.js',
				'/_app/assets/pages/lab/index.svelte-aee2d387.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-ab8cbe1f.js',
				'/_app/assets/Grid.svelte-5aca1e87.css',
				'/_app/chunks/Header-bff7bbb7.js',
