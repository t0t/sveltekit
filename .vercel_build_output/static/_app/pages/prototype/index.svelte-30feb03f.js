...
function Se(e) {
	let t, s, a, c, n, o, $, i, p, f, d, u, _, h, b, w, k, A, D, I, M, V, j, q, z, P;
	return (
		(t = new C({
			props: {
				tipo: 4,
		...
		})),
		{
			...
			p(e, s) {
				...
				const m = {};
				1 & s && (m.$$scope = { dirty: s, ctx: e }), _.$set(m);
				const f = {};
				1 & s && (f.$$scope = { dirty: s, ctx: e }), b.$set(f);
				const u = {};
				1 & s && (u.$$scope = { dirty: s, ctx: e }), k.$set(u);
				const h = {};
...
function Qe(e) {
	let t, s, a, c, n, o, $, i, p, f, d, u, _, h, b, w, k, A, D, I, M, V, j, q;
	return (
		(t = new C({
			props: {
				tipo: 4,
...
function Ze(e) {
	let t, s, a, c, n, o, $, i, p, f, d, u, h, b, w, k, A, I, M, V, C, j, q, z, P, H;
	return (
	...
	return (
		...
		(le = new D({ props: { tipo: 4, clases: 'tac c_4 pb_2 pt_2', title: 'Grid 12' } })),
		{
			...
			l(e) {
				...
				var Rt = o(rt);
				($t = f(Rt, '.col_12')), Rt.forEach(r), Nt.forEach(r), _t.forEach(r), this.h();
			},
			h() {
				$(u, 'class', ''),
					$(i, 'class', 'col_8 bgc_2'),
					...
					$(_e, 'class', ''),
					$(ue, 'class', 'col_2 bgc_5'),
					$(be, 'class', ''),
					$(xe, 'class', 'col_3 bgc_5'),
					$(Le, 'class', ''),
					$(Ee, 'class', 'col_4 bgc_2'),
					$(De, 'class', 'c_3'),
					$(Ae, 'class', 'col_5 bgc_0'),
					$(Ce, 'class', ''),
					$(Ve, 'class', 'col_6 bgc_1'),
					$(Pe, 'class', ''),
					$(ze, 'class', 'col_6 bgc_2'),
					$(Te, 'class', ''),
					$(Ge, 'class', 'col_7 bgc_3'),
					$(Ue, 'class', ''),
					$(Oe, 'class', 'col_8 bgc_5'),
					$(Ke, 'class', ''),
					$(We, 'class', 'col_9 bgc_3'),
					$(Ze, 'class', ''),
					$(Xe, 'class', 'col_10 bgc_3'),
					$(at, 'class', ''),
					$(st, 'class', 'col_11 bgc_3'),
					$(rt, 'class', ''),
					$(ot, 'class', 'col_12 bgc_4'),
					$(ge, 'class', 'dg_12 c_0 mh_3');
			},
			m(e, c) {
				L(t, e, c),
					l(e, s, c),
...
function $t(e) {
	let t, s, a, c, n, o, $, i, p, f, d, u, _, h, b, w, k, I;
	return (
		(t = new D({
			props: {
