...
import { c as E, B as j } from '../../chunks/Grid.svelte-916f7747.js';
import { t as w } from '../../chunks/tabsContent-d9de8955.js';
import { H as k } from '../../chunks/Header-cd15ff25.js';
/* empty css                                     */ import { I as D } from '../../chunks/Img-fdbb3f27.js';
import { S as I } from '../../chunks/Section-ef966e09.js';
import { L as S, a as V } from '../../chunks/ListItem-cf78d2b1.js';
import { T as C } from '../../chunks/Tabs-c8192f1e.js';
const H = [
	{
		language: 'scss',
		text:
...
function z(e) {
	...
	return {
		...
		h() {
			l(a, 'class', (f = 'language-' + e[0] + ' svelte-1opyebk')), l(t, 'class', 'svelte-1opyebk');
		},
		m(e, s) {
			$(e, t, s), m(t, a), m(a, g);
		},
		p(e, [t]) {
			2 & t && p(g, e[1]),
				1 & t && f !== (f = 'language-' + e[0] + ' svelte-1opyebk') && l(a, 'class', f);
		},
		i: d,
		o: d,
		d(e) {
...
function U(e) {
	...
	return (
		...
		(pe = new D({ props: { src: './img/grafico-11.svg', alt: '' } })),
		(fe = new k({
			props: {
				tipo: 3,
				variante: 6,
		...
		(Ee = new k({ props: { tipo: 1, variante: 1, title: 'Notas acerca de esta web' } })),
		(we = new I({
		...
		})),
		{
			...
			l(e) {
				...
				d = r(s, 'DIV', { class: !0 });
				var n = o(d);
				h(g.$$.fragment, n), n.forEach(i), (E = v(s)), (j = r(s, 'DIV', { class: !0 }));
				var l = o(j);
				...
				ne = r(k, 'DIV', { class: !0 });
				var D = o(ne);
				h(re.$$.fragment, D), D.forEach(i), (oe = v(k)), (ce = r(k, 'DIV', { class: !0 }));
				var I = o(ce);
				h(ie.$$.fragment, I),
					I.forEach(i),
					k.forEach(i),
			...
			h() {
				l(d, 'class', 'col_13 col_s2_8 mt_-4'),
					...
					l(ge, 'class', 'col_13 col_s2_5 dg_0 pcc c_4'),
