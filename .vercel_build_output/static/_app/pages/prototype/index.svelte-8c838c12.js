...
import { c as j, G as E, B as S } from '../../chunks/GridBase-a41c03d9.js';
import { T as k, t as D } from '../../chunks/Tabs-2bfa3994.js';
import { S as C, H as I } from '../../chunks/Header-c174dee5.js';
import { L as _, a as H } from '../../chunks/ListItem-8591f839.js';
...
function q(e) {
	...
	return {
		c() {
			(t = n('pre')), (a = n('code')), (f = r(e[1])), this.h();
		},
		l(n) {
			t = s(n, 'PRE', { class: !0 });
			var r = o(t);
		...
		h() {
			l(a, 'class', (u = 'language-' + e[0] + ' svelte-nswji5')), l(t, 'class', 'svelte-nswji5');
		},
		m(e, n) {
			c(e, t, n), m(t, a), m(a, f);
		},
		p(e, [t]) {
			2 & t && p(f, e[1]),
				1 & t && u !== (u = 'language-' + e[0] + ' svelte-nswji5') && l(a, 'class', u);
		},
		i: d,
		o: d,
		d(e) {
...
function L(e) {
	let t, a;
	return (
		(t = new I({ props: { tipo: 2, variante: 1, title: j[4].title, subtitle: j[4].subtitle } })),
		{
			c() {
				u(t.$$.fragment);
			},
...
function A(e) {
	...
	return {
		...
		m(e, n) {
			c(e, t, n), m(t, a), m(a, p), m(t, d), m(t, f), m(f, u), m(f, h), m(h, b), m(f, x);
		},
		d(e) {
			e && i(t);
		}
...
function M(e) {
	...
	return {
		...
		m(e, n) {
			c(e, t, n), m(t, a), m(a, p), m(t, d), m(t, f), m(f, u);
		},
		d(e) {
			e && i(t);
		}
	...
	return (
		...
		})),
		{
			...
			p(e, [a]) {
				...
				const p = {};
				1 & a && (p.$$scope = { dirty: a, ctx: e }), j.$set(p);
			},
			i(e) {
				E ||
					(x(t.$$.fragment, e),
