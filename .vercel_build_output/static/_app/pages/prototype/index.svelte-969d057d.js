...
import { S as C } from '../../chunks/Section-ebe14856.js';
import { L as M, a as V } from '../../chunks/ListItem-9aa7bd94.js';
...
function Y(e) {
	...
	return (
		...
		})),
		{
			...
			p: u,
			i(e) {
				C || (g(t.$$.fragment, e), g(i.$$.fragment, e), (C = !0));
			},
			o(e) {
				m(t.$$.fragment, e), m(i.$$.fragment, e), (C = !1);
			},
			d(e) {
...
function Se(e) {
	let t, s, a, c, n, o, $, i, p, f, d, _, u, h, b, w, k, A, D, I, C, M, j, q, z, P;
	return (
		(t = new V({
			props: {
				tipo: 4,
		...
		})),
		{
			...
			p(e, s) {
				...
				const v = {};
				1 & s && (v.$$scope = { dirty: s, ctx: e }), C.$set(v);
				const x = {};
...
function je(e) {
	...
	return (
		(t = new B({
			props: { clases: 'language-scss', $$slots: { default: [Ve] }, $$scope: { ctx: e } }
		})),
		{
			c() {
				y(t.$$.fragment);
...
function Qe(e) {
	let t, s, a, c, n, o, $, i, p, f, d, _, u, h, b, w, k, A, D, I, C, M, j, q;
	return (
		(t = new V({
			props: {
				tipo: 4,
...
function Ze(e) {
	let t, s, a, c, n, o, $, i, p, f, d, _, h, b, w, k, A, I, C, M, V, j, q, z, P, H;
	return (
