...
import { c as y, B as j } from '../../chunks/Grid.svelte-e568fec9.js';
import { t as w } from '../../chunks/tabsContent-d9de8955.js';
import { H as D } from '../../chunks/Header-72a33ab9.js';
/* empty css                                     */ import { I as k } from '../../chunks/Img-d7035d09.js';
import { S as I } from '../../chunks/Section-2abcbe78.js';
import { L as S, a as V } from '../../chunks/ListItem-ea6efde4.js';
import { T as C } from '../../chunks/Tabs-b86573a7.js';
const H = [
	{
		language: 'scss',
		text:
...
function q(e) {
	...
	return {
		...
		l(s) {
			...
			a = r(n, 'CODE', { class: !0 });
			var l = o(a);
			(g = c(l, e[1])), l.forEach(i), n.forEach(i), this.h();
		},
		h() {
			l(a, 'class', (f = 'language-' + e[0] + ' svelte-gvb6qh')), l(t, 'class', 'svelte-gvb6qh');
		},
		m(e, s) {
			$(e, t, s), m(t, a), m(a, g);
		},
		p(e, [t]) {
			2 & t && p(g, e[1]),
				1 & t && f !== (f = 'language-' + e[0] + ' svelte-gvb6qh') && l(a, 'class', f);
		},
		i: d,
		o: d,
		d(e) {
...
function U(e) {
	...
	return (
		(t = new I({
			props: { id: 'cover', variante: 1, $$slots: { default: [P] }, $$scope: { ctx: e } }
		})),
		(g = new G({ props: { language: H[1].language, code: H[1].text } })),
		(w = new D({
			props: {
				tipo: 3,
				variante: 6,
		...
		(te = new G({ props: { language: H[0].language, code: H[0].text } })),
		(re = new G({ props: { language: H[2].language, code: H[2].text } })),
		(ie = new S({
		...
		})),
		{
			...
			l(e) {
				...
				d = r(s, 'DIV', { class: !0 });
				var n = o(d);
				h(g.$$.fragment, n), n.forEach(i), (y = v(s)), (j = r(s, 'DIV', { class: !0 }));
				var l = o(j);
				h(w.$$.fragment, l), (C = v(l)), (q = r(l, 'P', {}));
				var $ = o(q);
				(z = c(
					$,
					'En mi opinión éste es el mejor framework de desarrollo. Cuando lo descubrí me enamoré al\n\t\t\tinstante y supe que ese sería mi motor de templates y mi generador de sitios web estáticos.'
				...
				me = r(S, 'DIV', { class: !0 });
				var V = o(me);
				h(pe.$$.fragment, V), V.forEach(i), (de = v(S)), (ge = r(S, 'DIV', { class: !0 }));
				var H = o(ge);
				h(fe.$$.fragment, H),
					(ue = v(H)),
					h(he.$$.fragment, H),
