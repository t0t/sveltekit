...
import { S as M } from '../../chunks/Section-ef966e09.js';
import { t as P } from '../../chunks/index-c4bdeab8.js';
import { b as C } from '../../chunks/index-78b22dae.js';
import { H as L } from '../../chunks/Header-cd15ff25.js';
...
function G(e) {
	let t, s, h, v, b, x, k, E, S, T, D, y, w, j, z, A, H;
	function I(e, t) {
		return e[5] ? V : N;
	}
	let M = I(e),
	...
	return {
		...
		l(n) {
			...
			(x = c(l, e[0])),
				...
				(y = o(r, 'DIV', { class: !0 }));
			var u = a(y);
			w = o(u, 'BUTTON', { class: !0 });
			var m = a(w);
			P.l(m), m.forEach(d), u.forEach(d), (j = i(r)), (z = o(r, 'DL', { class: !0 }));
			var f = a(z);
			G.l(f), f.forEach(d), r.forEach(d), this.h();
		},
		h() {
			u(s, 'class', 'Avatar svelte-uolthz'),
				s.src !== (h = e[4]) && u(s, 'src', h),
				u(s, 'alt', e[0]),
				u(E, 'class', 'svelte-uolthz'),
				u(T, 'class', 'AboutMeText svelte-uolthz'),
				u(b, 'class', 'AboutMeHeader svelte-uolthz'),
				u(w, 'class', 'svelte-uolthz'),
				u(y, 'class', 'idioma_switch svelte-uolthz'),
				u(z, 'class', 'timeline svelte-uolthz'),
				u(t, 'class', 'AboutMe svelte-uolthz');
		},
		m(n, r) {
			m(n, t, r),
				f(t, s),
		...
		p(e, [t]) {
			16 & t && s.src !== (h = e[4]) && u(s, 'src', h),
				...
				L === (L = C(e)) && G ? G.p(e, t) : (G.d(1), (G = L(e)), G && (G.c(), G.m(z, null)));
		},
		i: $,
		o: $,
		d(e) {
...
function U(e) {
	...
	return {
		...
		l(n) {
			...
			s = o(r, 'SPAN', { class: !0 });
			var l = a(s);
			(p = c(l, e[0])), l.forEach(d), (h = i(r)), (v = o(r, 'DIV', { class: !0, style: !0 }));
			var u = a(v);
			(b = c(u, e[1])), (x = c(u, '%')), u.forEach(d), r.forEach(d), this.h();
		},
		h() {
			u(s, 'class', 'skill svelte-7x1roj'),
				u(v, 'class', 'skills svelte-7x1roj'),
				j(v, 'width', e[3] + '%'),
				j(v, 'background-color', e[2]),
				u(t, 'class', 'container svelte-7x1roj');
		},
		m(e, n) {
			m(e, t, n), f(t, s), f(s, p), f(t, h), f(t, v), f(v, b), f(v, x);
		},
		p(e, [t]) {
			1 & t && g(p, e[0]),
				2 & t && g(b, e[1]),
...
function K(e, t, s) {
	let n,
		...
		{ color: o } = t,
		{ delTime: a } = t;
	const i = P(30, { delay: a, duration: 2e3, easing: C });
	return (
		z(e, i, (e) => s(3, (n = e))),
		i.set(l),
		(e.$$set = (e) => {
		...
		p(e, [s]) {
			if (0 & s) {
				...
				for (r = R, n = 0; n < r.length; n += 1) {
					...
					l[n]
						? (l[n].p(o, s), D(l[n], 1))
						: ((l[n] = Y(o)), l[n].c(), D(l[n], 1), l[n].m(t, null));
				}
...
function ne(e) {
	...
	return (
		...
		{
			c() {
				x(t.$$.fragment), (s = r()), x(n.$$.fragment), (l = r()), x(o.$$.fragment);
			},
			l(e) {
				k(t.$$.fragment, e), (s = i(e)), k(n.$$.fragment, e), (l = i(e)), k(o.$$.fragment, e);
			},
			m(e, r) {
				E(t, e, r), m(e, s, r), E(n, e, r), m(e, l, r), E(o, e, r), (a = !0);
			},
			p(e, [s]) {
				const n = {};
				1 & s && (n.$$scope = { dirty: s, ctx: e }), t.$set(n);
				const r = {};
				1 & s && (r.$$scope = { dirty: s, ctx: e }), o.$set(r);
			},
			i(e) {
				a || (D(t.$$.fragment, e), D(n.$$.fragment, e), D(o.$$.fragment, e), (a = !0));
			},
			o(e) {
				y(t.$$.fragment, e), y(n.$$.fragment, e), y(o.$$.fragment, e), (a = !1);
			},
			d(e) {
				w(t, e), e && d(s), w(n, e), e && d(l), w(o, e);
			}
		}
	);
}
