...
import { S as M, H as P } from '../../chunks/Header-cc4c0be9.js';
...
function G(e) {
	let t, s, h, v, b, k, x, E, T, y, S, D, j, w, z, A, H;
	function I(e, t) {
		return e[5] ? V : N;
	}
	let M = I(e),
	...
	return {
		...
		l(n) {
			...
			var m = o(j);
			P.l(m), m.forEach(d), u.forEach(d), (w = i(r)), (z = a(r, 'DL', { class: !0 }));
			var p = o(z);
			G.l(p), p.forEach(d), r.forEach(d), this.h();
		},
		h() {
			u(s, 'class', 'Avatar svelte-z4442j'),
				s.src !== (h = e[4]) && u(s, 'src', h),
				u(s, 'alt', e[0]),
				u(E, 'class', 'svelte-z4442j'),
				u(y, 'class', 'AboutMeText svelte-z4442j'),
				u(b, 'class', 'AboutMeHeader svelte-z4442j'),
				u(j, 'class', 'svelte-z4442j'),
				u(D, 'class', 'idioma_switch svelte-z4442j'),
				u(z, 'class', 'timeline svelte-z4442j'),
				u(t, 'class', 'AboutMe svelte-z4442j');
		},
		m(n, r) {
			m(n, t, r),
				p(t, s),
		...
		p(e, [t]) {
			16 & t && s.src !== (h = e[4]) && u(s, 'src', h),
				...
				1 & t && g(k, e[0]),
				2 & t && (y.innerHTML = e[1]),
				M !== (M = I(e)) && (P.d(1), (P = M(e)), P && (P.c(), P.m(j, null))),
...
function U(e) {
	...
	return {
		...
		h() {
			u(s, 'class', 'skill svelte-118doin'),
				u(v, 'class', 'skills svelte-118doin'),
				w(v, 'width', e[3] + '%'),
				w(v, 'background-color', e[2]),
				u(t, 'class', 'container svelte-118doin');
		},
		m(e, n) {
