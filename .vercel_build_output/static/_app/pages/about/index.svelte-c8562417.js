...
import { S as P } from '../../chunks/Section-b98eefba.js';
import { t as C } from '../../chunks/index-c4bdeab8.js';
import { b as L } from '../../chunks/index-78b22dae.js';
import { H as N } from '../../chunks/Header-bff7bbb7.js';
...
function G(e) {
	...
	return {
		...
		l(n) {
			...
			var m = o(w);
			C.l(m), m.forEach(d), u.forEach(d), (A = i(r)), (H = a(r, 'DL', { class: !0 }));
			var f = o(H);
			G.l(f), f.forEach(d), r.forEach(d), this.h();
		},
		h() {
			u(s, 'class', 'Avatar svelte-r49asf'),
				s.src !== (h = e[4]) && u(s, 'src', h),
				u(s, 'alt', e[0]),
				u(E, 'class', 'svelte-r49asf'),
				u(T, 'class', 'AboutMeText svelte-r49asf'),
				u(b, 'class', 'AboutMeHeader svelte-r49asf'),
				u(w, 'class', 'svelte-r49asf'),
				u(y, 'class', 'idioma_switch svelte-r49asf'),
				u(H, 'class', 'timeline svelte-r49asf'),
				u(t, 'class', 'AboutMe svelte-r49asf');
		},
		m(n, r) {
			m(n, t, r),
				f(t, s),
...
function U(e) {
	...
	return {
		...
		l(n) {
			...
			s = a(r, 'SPAN', { class: !0 });
			var l = o(s);
			(p = c(l, e[0])), l.forEach(d), (h = i(r)), (v = a(r, 'DIV', { class: !0, style: !0 }));
			var u = o(v);
			(b = c(u, e[1])), (k = c(u, '%')), u.forEach(d), r.forEach(d), this.h();
		},
		h() {
			u(s, 'class', 'skill svelte-1gn3usr'),
				u(v, 'class', 'skills svelte-1gn3usr'),
				A(v, 'width', e[3] + '%'),
				A(v, 'background-color', e[2]),
				u(t, 'class', 'container svelte-1gn3usr');
		},
		m(e, n) {
...
function K(e, t, s) {
	let n,
		...
		{ color: a } = t,
		{ delTime: o } = t;
	const i = C(30, { delay: o, duration: 2e3, easing: L });
	return (
		H(e, i, (e) => s(3, (n = e))),
		i.set(l),
		(e.$$set = (e) => {
	...
	return {
		...
		p(e, [s]) {
			if (0 & s) {
				...
				for (j(), n = r.length; n < l.length; n += 1) i(n);
				I();
			}
		},
		i(e) {
