...
import { S as P, H as C } from '../../chunks/Header-8a27feeb.js';
...
function G(e) {
	let t, s, h, v, b, k, x, w, E, T, S, D, y, j, A, H, I;
	function M(e, t) {
		return e[5] ? _ : V;
	}
	let P = M(e),
	...
	return {
		...
		l(n) {
			...
			(k = c(l, e[0])),
				...
				(D = a(r, 'DIV', { class: !0 }));
			var m = o(D);
			y = a(m, 'BUTTON', { class: !0 });
			var u = o(y);
			C.l(u), u.forEach(d), m.forEach(d), (j = i(r)), (A = a(r, 'DL', { class: !0 }));
			var p = o(A);
			G.l(p), p.forEach(d), r.forEach(d), this.h();
		},
		h() {
			m(s, 'class', 'Avatar svelte-1mc2wn8'),
				s.src !== (h = e[4]) && m(s, 'src', h),
				m(s, 'alt', e[0]),
				m(w, 'class', 'svelte-1mc2wn8'),
				m(T, 'class', 'AboutMeText svelte-1mc2wn8'),
				m(b, 'class', 'AboutMeHeader svelte-1mc2wn8'),
				m(y, 'class', 'svelte-1mc2wn8'),
				m(D, 'class', 'idioma_switch svelte-1mc2wn8'),
				m(A, 'class', 'timeline svelte-1mc2wn8'),
				m(t, 'class', 'AboutMe svelte-1mc2wn8');
		},
		m(n, r) {
			u(n, t, r),
				p(t, s),
		...
		p(e, [t]) {
			16 & t && s.src !== (h = e[4]) && m(s, 'src', h),
				...
				1 & t && g(k, e[0]),
				2 & t && (T.innerHTML = e[1]),
				P !== (P = M(e)) && (C.d(1), (C = P(e)), C && (C.c(), C.m(y, null))),
				N === (N = L(e)) && G ? G.p(e, t) : (G.d(1), (G = N(e)), G && (G.c(), G.m(A, null)));
		},
		i: $,
		o: $,
		d(e) {
...
function U(e) {
	...
	return {
		...
		h() {
			m(s, 'class', 'skill svelte-pv4mj4'),
				m(v, 'class', 'skills svelte-pv4mj4'),
				j(v, 'width', e[3] + '%'),
				j(v, 'background-color', e[2]),
				m(t, 'class', 'container svelte-pv4mj4');
		},
		m(e, n) {
...
function ne(e) {
	...
	return (
		...
		})),
		{
			...
			m(e, r) {
				w(t, e, r), u(e, s, r), w(n, e, r), u(e, l, r), w(a, e, r), (o = !0);
			},
			p(e, [s]) {
				const n = {};
