...
import { S as z } from '../../chunks/Section-ebe14856.js';
import { t as P } from '../../chunks/index-c4bdeab8.js';
import { b as C } from '../../chunks/index-78b22dae.js';
import { H as L } from '../../chunks/Header-33a8b362.js';
...
function G(e) {
	...
	return {
		...
		l(n) {
			...
			var m = o(w);
			P.l(m), m.forEach(d), u.forEach(d), (A = i(r)), (H = a(r, 'DL', { class: !0 }));
			var p = o(H);
			G.l(p), p.forEach(d), r.forEach(d), this.h();
		},
		h() {
			u(s, 'class', 'Avatar svelte-7t861'),
				s.src !== (h = e[4]) && u(s, 'src', h),
				u(s, 'alt', e[0]),
				u(E, 'class', 'svelte-7t861'),
				u(T, 'class', 'AboutMeText svelte-7t861'),
				u(b, 'class', 'AboutMeHeader svelte-7t861'),
				u(w, 'class', 'svelte-7t861'),
				u(y, 'class', 'idioma_switch svelte-7t861'),
				u(H, 'class', 'timeline svelte-7t861'),
				u(t, 'class', 'AboutMe svelte-7t861');
		},
		m(n, r) {
			m(n, t, r),
				p(t, s),
		...
		p(e, [t]) {
			16 & t && s.src !== (h = e[4]) && u(s, 'src', h),
				...
				L === (L = C(e)) && G ? G.p(e, t) : (G.d(1), (G = L(e)), G && (G.c(), G.m(H, null)));
		},
		i: $,
		o: $,
		d(e) {
...
function U(e) {
	...
	return {
		...
		h() {
			u(s, 'class', 'skill svelte-tu2azp'),
				u(v, 'class', 'skills svelte-tu2azp'),
				A(v, 'width', e[3] + '%'),
				A(v, 'background-color', e[2]),
				u(t, 'class', 'container svelte-tu2azp');
		},
		m(e, n) {
