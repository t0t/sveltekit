...
import { C as A, c as H } from '../../chunks/Cover-4d50fe6e.js';
import { G as T } from '../../chunks/GridBase-543be129.js';
...
function R(e) {
	...
	return {
		...
		h() {
			c(a, 'class', (g = u(e[0] === e[3].id ? 'active' : '') + ' svelte-1a0ypm6'));
		},
		m(r, o) {
			d(r, a, o),
				m(a, t),
		...
		p(r, o) {
			(e = r),
				...
				3 & o &&
					g !== (g = u(e[0] === e[3].id ? 'active' : '') + ' svelte-1a0ypm6') &&
					c(a, 'class', g);
		},
		d(e) {
			e && l(a), ($ = !1), b();
...
function V(e) {
	...
	return {
		c() {
			(a = r('article')), (t = r('h2')), (u = o(v)), (f = $()), (p = r('p')), (g = $()), this.h();
		},
		l(e) {
		...
		h() {
			c(t, 'class', 'svelte-1a0ypm6'),
				c(p, 'class', 'svelte-1a0ypm6'),
				c(a, 'class', 'svelte-1a0ypm6');
		},
		m(e, r) {
			d(e, a, r), m(a, t), m(t, u), m(a, f), m(a, p), (p.innerHTML = y), m(a, g);
		},
		p(e, a) {
			2 & a && v !== (v = e[3].subtitle + '') && h(u, v),
				2 & a && y !== (y = e[3].content + '') && (p.innerHTML = y);
		},
		d(e) {
			e && l(a);
		}
...
function N(e) {
	let a,
		...
		i = e[1],
		u = [];
	for (let r = 0; r < i.length; r += 1) u[r] = R(S(e, i, r));
	let m = e[1],
		f = [];
	for (let r = 0; r < m.length; r += 1) f[r] = M(w(e, m, r));
	return {
		c() {
			a = r('nav');
		...
		l(e) {
			a = s(e, 'NAV', { class: !0 });
			var r = n(a);
			for (let a = 0; a < u.length; a += 1) u[a].l(r);
			r.forEach(l), (t = b(e));
		...
		p(e, [t]) {
			if (7 & t) {
				...
				for (i = e[1], r = 0; r < i.length; r += 1) {
					const o = S(e, i, r);
					u[r] ? u[r].p(o, t) : ((u[r] = R(o)), u[r].c(), u[r].m(a, null));
				}
			...
			if (3 & t) {
				...
				for (m = e[1], a = 0; a < m.length; a += 1) {
					const r = w(e, m, a);
					f[a] ? f[a].p(r, t) : ((f[a] = M(r)), f[a].c(), f[a].m(o.parentNode, o));
				}
...
class P extends e {
	constructor(e) {
		super(), a(this, e, U, N, t, { tabsContent: 1, activeTabValue: 0 });
	}
}
const G = [
	{
	...
	return {
		...
		l(e) {
			...
			(t = s(c, 'path', { fill: !0, stroke: !0, 'stroke-width': !0, d: !0 }, 1)),
				...
				n(i).forEach(l),
				(u = s(c, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				n(u).forEach(l),
		...
		h() {
			c(t, 'fill', 'none'),
				...
				c(u, 'cy', '257.8'),
				c(u, 'r', '6'),
				c(u, 'transform', 'translate(-17 -8) scale(.67024)'),
				c(f, 'cx', '214.1'),
				c(f, 'cy', '257.8'),
				c(f, 'r', '6'),
...
function J(e) {
	...
	return {
		...
		l(e) {
			...
			t = s(r, 'H2', {});
			var o = n(t);
			(u = i(o, '+0+1234')), o.forEach(l), (f = b(r)), (p = s(r, 'H3', {}));
			var c = n(p);
		...
		m(e, r) {
			d(e, a, r), m(a, t), m(t, u), m(a, f), m(a, p), m(p, h), m(a, g), m(a, v), m(v, y);
		},
		d(e) {
			e && l(a);
		}
...
function O(e) {
	...
	return {
		...
		l(e) {
			...
			var o = n(t);
			(u = i(o, 'Slides')), o.forEach(l), (f = b(r)), (p = s(r, 'A', { href: !0, target: !0 }));
			var c = n(p);
		...
		m(e, r) {
			d(e, a, r), m(a, t), m(t, u), m(a, f), m(a, p), m(p, h);
		},
		d(e) {
			e && l(a);
		}
...
function K(e) {
	...
	return (
		...
		})),
		{
			...
			m(e, i) {
				q(a, e, i), d(e, t, i), q(r, e, i), d(e, o, i), q(s, e, i), (n = !0);
			},
			p(e, [t]) {
				const o = {};
			...
			i(e) {
				n || (C(a.$$.fragment, e), C(r.$$.fragment, e), C(s.$$.fragment, e), (n = !0));
			},
			o(e) {
				j(a.$$.fragment, e), j(r.$$.fragment, e), j(s.$$.fragment, e), (n = !1);
			},
			d(e) {
