...
import { G as A, C as I, c as P } from '../../chunks/Cover-a94e894d.js';
import { S as H } from '../../chunks/Section-db7b341b.js';
function M(e) {
	let t, i, f;
	const h = e[4].default,
		$ = s(h, e, e[3], null);
	return {
		c() {
			(t = a('section')), $ && $.c(), this.h();
		},
		l(e) {
			t = r(e, 'SECTION', { id: !0, class: !0 });
			var i = o(t);
			$ && $.l(i), i.forEach(n), this.h();
		},
		h() {
			l(t, 'id', e[1]), l(t, 'class', (i = c(e[2][e[0]]) + ' svelte-eqyc2h'));
		},
		m(e, i) {
			u(e, t, i), $ && $.m(t, null), (f = !0);
		},
		p(e, [s]) {
			$ && $.p && 8 & s && m($, h, e, e[3], s, null, null),
				(!f || 2 & s) && l(t, 'id', e[1]),
				(!f || (1 & s && i !== (i = c(e[2][e[0]]) + ' svelte-eqyc2h'))) && l(t, 'class', i);
		},
		i(e) {
			f || (d($, e), (f = !0));
		},
...
function _(e, t, i) {
	...
	return (
		(e.$$set = (e) => {
			'variante' in e && i(0, (r = e.variante)),
				'id' in e && i(1, (o = e.id)),
...
class k extends e {
	constructor(e) {
		super(), t(this, e, _, M, i, { variante: 0, id: 1 });
	}
}
function G(e, t, i) {
	const s = e.slice();
...
function R(e) {
	...
	return {
		c() {
			(t = a('button')), (i = f(p)), this.h();
		},
		l(e) {
			t = r(e, 'BUTTON', { class: !0 });
			var s = o(t);
			(i = h(s, p)), s.forEach(n), this.h();
		},
		h() {
			l(t, 'class', (s = c(e[0] === e[3].id ? 'active' : '') + ' svelte-t1reyv'));
		},
		m(s, a) {
			u(s, t, a),
				$(t, i),
				m ||
					((d = g(t, 'click', function () {
						b(e[2](e[3].id)) && e[2](e[3].id).apply(this, arguments);
					})),
					(m = !0));
		},
		p(a, r) {
			(e = a),
				2 & r && p !== (p = e[3].title + '') && v(i, p),
				3 & r &&
					s !== (s = c(e[0] === e[3].id ? 'active' : '') + ' svelte-t1reyv') &&
					l(t, 'class', s);
		},
		d(e) {
			e && n(t), (m = !1), d();
...
function D(e) {
	let t, i;
	return (
		(t = new k({ props: { variante: 6, $$slots: { default: [F] }, $$scope: { ctx: e } } })),
		{
			c() {
				q(t.$$.fragment);
			},
			...
			p(e, i) {
				const s = {};
				258 & i && (s.$$scope = { dirty: i, ctx: e }), t.$set(s);
			},
			i(e) {
				i || (d(t.$$.fragment, e), (i = !0));
			},
			o(e) {
				p(t.$$.fragment, e), (i = !1);
			},
...
function U(e) {
	...
	return {
		...
		l(e) {
			(t = r(e, 'P', { class: !0 })), o(t).forEach(n), this.h();
		},
		h() {
			l(t, 'class', 'svelte-t1reyv');
		},
		m(e, s) {
			u(e, t, s), (t.innerHTML = i);
		},
		p(e, s) {
			2 & s && i !== (i = e[3].content + '') && (t.innerHTML = i);
		},
		d(e) {
			e && n(t);
		}
...
function O(e) {
	...
	return {
		c() {
			(t = a('figure')), (i = a('img')), (m = j()), (d = a('figcaption')), (p = f(g)), this.h();
		},
		l(e) {
			t = r(e, 'FIGURE', { slot: !0, class: !0 });
			var s = o(t);
			(i = r(s, 'IMG', { src: !0, alt: !0, class: !0 })),
				(m = z(s)),
				(d = r(s, 'FIGCAPTION', { class: !0 }));
			var a = o(d);
			(p = h(a, g)), a.forEach(n), s.forEach(n), this.h();
		},
		h() {
			i.src !== (s = e[3].img) && l(i, 'src', s),
				l(i, 'alt', (c = e[3].subtitle)),
				l(i, 'class', 'svelte-t1reyv'),
				l(d, 'class', 'svelte-t1reyv'),
				l(t, 'slot', 'subarea1'),
				l(t, 'class', 'svelte-t1reyv');
		},
		m(e, s) {
			u(e, t, s), $(t, i), $(t, m), $(t, d), $(d, p);
		},
		p(e, t) {
			2 & t && i.src !== (s = e[3].img) && l(i, 'src', s),
				2 & t && c !== (c = e[3].subtitle) && l(i, 'alt', c),
				2 & t && g !== (g = e[3].subtitle + '') && v(p, g);
		},
		d(e) {
			e && n(t);
		}
...
function B(e) {
	...
	return {
		c() {
			(t = a('small')), (i = f(s)), this.h();
		},
		l(e) {
			t = r(e, 'SMALL', { slot: !0, class: !0 });
			var a = o(t);
			(i = h(a, s)), a.forEach(n), this.h();
		},
		h() {
			l(t, 'slot', 'subarea2'), l(t, 'class', 'svelte-t1reyv');
		},
		m(e, s) {
			u(e, t, s), $(t, i);
		},
		p(e, t) {
			2 & t && s !== (s = e[3].tags + '') && v(i, s);
		},
		d(e) {
			e && n(t);
		}
...
function F(e) {
	...
	return (
		(t = new A({
			props: {
				variante: 3,
				$$slots: { subarea2: [B], subarea1: [O], default: [U] },
				$$scope: { ctx: e }
			}
		})),
		{
...
function J(e) {
	...
	return {
		...
		m(e, a) {
			s && s.m(e, a), u(e, t, a), (i = !0);
		},
		p(e, i) {
			e[0] == e[3].id
				? s
					? (s.p(e, i), 3 & i && d(s, 1))
					: ((s = D(e)), s.c(), d(s, 1), s.m(t.parentNode, t))
				: s &&
				  (V(),
				  p(s, 1, 1, () => {
						s = null;
...
function Q(e) {
	let t,
		...
		m = e[1],
		f = [];
	for (let a = 0; a < m.length; a += 1) f[a] = R(N(e, m, a));
	let h = e[1],
		$ = [];
	for (let a = 0; a < h.length; a += 1) $[a] = J(G(e, h, a));
	const g = (e) =>
		p($[e], 1, 1, () => {
			$[e] = null;
		});
	return {
		...
		l(e) {
			t = r(e, 'NAV', { class: !0 });
			var a = o(t);
			for (let t = 0; t < f.length; t += 1) f[t].l(a);
			a.forEach(n), (i = z(e));
		...
		m(e, a) {
			u(e, t, a);
			for (let i = 0; i < f.length; i += 1) f[i].m(t, null);
			u(e, i, a);
			for (let t = 0; t < $.length; t += 1) $[t].m(e, a);
			u(e, s, a), (c = !0);
		},
		p(e, [i]) {
			if (7 & i) {
				let s;
				for (m = e[1], s = 0; s < m.length; s += 1) {
					const a = N(e, m, s);
					f[s] ? f[s].p(a, i) : ((f[s] = R(a)), f[s].c(), f[s].m(t, null));
				}
			...
			if (3 & i) {
				let t;
				for (h = e[1], t = 0; t < h.length; t += 1) {
					const a = G(e, h, t);
					$[t]
						? ($[t].p(a, i), d($[t], 1))
						: (($[t] = J(a)), $[t].c(), d($[t], 1), $[t].m(s.parentNode, s));
				}
				for (V(), t = h.length; t < $.length; t += 1) g(t);
				C();
			}
		},
		i(e) {
			if (!c) {
				for (let e = 0; e < h.length; e += 1) d($[e]);
				c = !0;
			}
		},
		o(e) {
			$ = $.filter(Boolean);
			for (let t = 0; t < $.length; t += 1) p($[t]);
			c = !1;
		},
		d(e) {
			e && n(t), w(f, e), e && n(i), w($, e), e && n(s);
		}
	};
}
function K(e, t, i) {
	let { tabsContent: s = [] } = t,
		{ activeTabValue: a = 1 } = t;
	return (
		(e.$$set = (e) => {
			'tabsContent' in e && i(1, (s = e.tabsContent)),
				'activeTabValue' in e && i(0, (a = e.activeTabValue));
		}),
		[a, s, (e) => () => i(0, (a = e))]
	);
}
class X extends e {
	constructor(e) {
		super(), t(this, e, K, Q, i, { tabsContent: 1, activeTabValue: 0 });
	}
}
const W = [
	{
...
function te(e) {
	...
	return {
		...
		l(e) {
			t = r(e, 'svg', { 'fill-rule': !0, 'clip-rule': !0, viewBox: !0 }, 1);
			var l = o(t);
			(i = r(l, 'path', { fill: !0, stroke: !0, 'stroke-width': !0, d: !0 }, 1)),
				o(i).forEach(n),
				(s = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(s).forEach(n),
				(a = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(a).forEach(n),
				(c = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(c).forEach(n),
				(m = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(m).forEach(n),
				(d = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(d).forEach(n),
				(p = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(p).forEach(n),
				(f = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(f).forEach(n),
				(h = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(h).forEach(n),
				(g = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(g).forEach(n),
				(b = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(b).forEach(n),
				l.forEach(n),
				this.h();
		},
		h() {
			l(i, 'fill', 'none'),
				...
				l(s, 'cy', '18.1'),
				l(s, 'r', '6'),
				l(s, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(a, 'cx', '214.1'),
				l(a, 'cy', '98.5'),
				l(a, 'r', '6'),
				l(a, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(c, 'cx', '259.9'),
				l(c, 'cy', '178.2'),
				l(c, 'r', '6'),
				l(c, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(m, 'cx', '305.7'),
				l(m, 'cy', '257.8'),
				l(m, 'r', '6'),
				l(m, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(d, 'cx', '214.1'),
				l(d, 'cy', '257.8'),
				l(d, 'r', '6'),
				l(d, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(p, 'cx', '123.2'),
				l(p, 'cy', '257.8'),
				l(p, 'r', '6'),
				l(p, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(f, 'cx', '30.8'),
				l(f, 'cy', '257.8'),
				l(f, 'r', '6'),
				l(f, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(h, 'cx', '76.9'),
				l(h, 'cy', '178.2'),
				l(h, 'r', '6'),
				l(h, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(g, 'cx', '168.3'),
				l(g, 'cy', '178.2'),
				l(g, 'r', '6'),
				l(g, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(b, 'cx', '123.2'),
				l(b, 'cy', '98.5'),
				l(b, 'r', '6'),
				l(b, 'transform', 'translate(-17 -8) scale(.67024)'),
				l(t, 'fill-rule', 'evenodd'),
				l(t, 'clip-rule', 'evenodd'),
				l(t, 'viewBox', '0 0 193 169');
		},
		m(e, r) {
			u(e, t, r),
				$(t, i),
	...
	return {
		c() {
			(t = a('hgroup')),
				...
				(c = j()),
				(m = a('h3')),
				(d = f('Hacia el encuentro con todo lo que Es')),
				(p = j()),
				(g = a('h4')),
				(b = f(
		...
		l(e) {
			...
			i = r(a, 'H2', {});
			var l = o(i);
			(s = h(l, '+0+1234')), l.forEach(n), (c = z(a)), (m = r(a, 'H3', {}));
			var u = o(m);
			(d = h(u, 'Hacia el encuentro con todo lo que Es')),
				u.forEach(n),
				(p = z(a)),
				(g = r(a, 'H4', {}));
			var f = o(g);
		...
		m(e, a) {
			u(e, t, a), $(t, i), $(i, s), $(t, c), $(t, m), $(m, d), $(t, p), $(t, g), $(g, b);
		},
		d(e) {
			e && n(t);
		}
...
function se(e) {
	...
	return {
		...
		l(e) {
			t = r(e, 'NAV', { slot: !0 });
			var a = o(t);
			i = r(a, 'A', { href: !0, target: !0 });
			var l = o(i);
			(s = h(l, 'Slides')), l.forEach(n), (c = z(a)), (m = r(a, 'A', { href: !0, target: !0 }));
			var u = o(m);
			(d = h(u, 'Libro')), u.forEach(n), a.forEach(n), this.h();
		},
		h() {
			l(i, 'href', 'https://slides.com/sergiofores/'),
				l(i, 'target', '_blank'),
				l(
					m,
					'href',
...
function ae(e) {
	...
	return (
		(t = new A({
			props: {
				variante: 1,
				$$slots: { subarea2: [se], subarea1: [ie], default: [te] },
				$$scope: { ctx: e }
			}
		})),
		{
			...
			p(e, i) {
				const s = {};
				1 & i && (s.$$scope = { dirty: i, ctx: e }), t.$set(s);
			},
			i(e) {
				i || (d(t.$$.fragment, e), (i = !0));
			},
...
function re(e) {
	...
	return {
		...
		h() {
			t.src !== (i = './img/logo.svg') && l(t, 'src', './img/logo.svg'), l(t, 'alt', '');
		},
		m(e, i) {
			u(e, t, i);
		},
...
function le(e) {
	...
	return (
		(t = new A({
			props: {
				variante: 0,
				$$slots: { subarea2: [ne], subarea1: [oe], default: [re] },
				$$scope: { ctx: e }
			}
		})),
		{
...
function ce(e) {
	...
	return {
		...
		h() {
			t.src !== (i = './img/01234_bn.svg') && l(t, 'src', './img/01234_bn.svg'), l(t, 'alt', '');
		},
		m(e, i) {
			u(e, t, i);
		},
...
function de(e) {
	...
	return (
		(t = new A({
			props: {
				variante: 2,
				$$slots: { subarea2: [me], subarea1: [ue], default: [ce] },
				$$scope: { ctx: e }
			}
		})),
		{
...
function pe(e) {
	...
	return {
		...
		h() {
			t.src !== (i = './img/grafico-8.svg') && l(t, 'src', './img/grafico-8.svg'), l(t, 'alt', '');
		},
		m(e, i) {
			u(e, t, i);
		},
...
function $e(e) {
	...
	return (
		(t = new A({
			props: {
				variante: 2,
				$$slots: { subarea2: [he], subarea1: [fe], default: [pe] },
				$$scope: { ctx: e }
			}
		})),
		{
...
function be(e) {
	let t, i, s, a, r, o, l, c, m, f, h, $;
	return (
		(t = new H({
			props: { id: 'philosophy', variante: 3, $$slots: { default: [ee] }, $$scope: { ctx: e } }
		})),
		(s = new H({ props: { variante: 0, $$slots: { default: [ae] }, $$scope: { ctx: e } } })),
		(r = new H({ props: { variante: 0, $$slots: { default: [le] }, $$scope: { ctx: e } } })),
		(l = new H({ props: { variante: 0, $$slots: { default: [de] }, $$scope: { ctx: e } } })),
		(m = new H({ props: { variante: 4, $$slots: { default: [$e] }, $$scope: { ctx: e } } })),
		(h = new H({
			props: { id: 'tabheaders', variante: 5, $$slots: { default: [ge] }, $$scope: { ctx: e } }
		})),
		{
			c() {
				q(t.$$.fragment),
			...
			p(e, [i]) {
				const a = {};
				1 & i && (a.$$scope = { dirty: i, ctx: e }), t.$set(a);
				const o = {};
				1 & i && (o.$$scope = { dirty: i, ctx: e }), s.$set(o);
				const n = {};
				1 & i && (n.$$scope = { dirty: i, ctx: e }), r.$set(n);
				const c = {};
				1 & i && (c.$$scope = { dirty: i, ctx: e }), l.$set(c);
				const u = {};
				1 & i && (u.$$scope = { dirty: i, ctx: e }), m.$set(u);
				const d = {};
				1 & i && (d.$$scope = { dirty: i, ctx: e }), h.$set(d);
			},
			i(e) {
				$ ||
					(d(t.$$.fragment, e),
