...
import { c as b, B as y } from '../../chunks/Grid.svelte-f6369e02.js';
import { t as q } from '../../chunks/miProceso-ec715937.js';
import { H as j } from '../../chunks/Header-33a8b362.js';
import { S as I } from '../../chunks/Section-ebe14856.js';
import { T as w } from '../../chunks/Tabs-ea9ec3d7.js';
import { I as D } from '../../chunks/Img-4bbf7ce3.js';
import { L as H, a as V } from '../../chunks/ListItem-50336afd.js';
function k(e) {
	let a, r, t, c;
	return (
		...
		})),
		{
			...
			l(e) {
				...
				(Ee = u(
					...
					(be = m(D, 'P', {}));
				var k = f(be);
				(ye = u(k, 'Los 5 arjés. Estructura dinámica sobre la que se asienta toda la Creación.')),
					k.forEach($),
					(qe = i(D)),
					(je = m(D, 'P', {}));
				var C = f(je);
			...
			h() {
				d(q, 'fill', 'none'),
					...
					d(y, 'fill-rule', 'evenodd'),
					d(y, 'clip-rule', 'evenodd'),
					d(y, 'viewBox', '0 0 193 169'),
					d(b, 'class', 'col_13 col_s2_5'),
					d(O, 'class', 'col_13'),
					d(U, 'class', 'col_13'),
					d(N, 'class', 'dg'),
