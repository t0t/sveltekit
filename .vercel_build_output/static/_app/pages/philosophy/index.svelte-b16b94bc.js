...
import { c as b, B as q } from '../../chunks/Grid.svelte-393f5de7.js';
import { t as _ } from '../../chunks/tabsContent-d9de8955.js';
import { H as j } from '../../chunks/Header-2dba8d98.js';
import { S as I } from '../../chunks/Section-2e905ef9.js';
import { T as w } from '../../chunks/Tabs-b19f8991.js';
import { I as D } from '../../chunks/Img-01748947.js';
import { L as H, a as V } from '../../chunks/ListItem-df6649ee.js';
function k(e) {
	let a, r, t, n;
	return (
...
function z(e) {
	let a, r;
	return (
		(a = new q({ props: { variante: 3, text: 'Slides' } })),
		{
			c() {
				s(a.$$.fragment);
			},
...
function P(e) {
	let a, r;
	return (
		(a = new q({ props: { variante: 3, text: 'Libro' } })),
		{
			c() {
				s(a.$$.fragment);
			},
...
function C(e) {
	...
	return (
		...
		})),
		{
			...
			o(e) {
				E(a.$$.fragment, e), E(o.$$.fragment, e), (n = !1);
			},
			d(e) {
				x(a, e), e && d(r), x(o, e);
			}
		...
		})),
		{
			c() {
				s(a.$$.fragment),
					...
					(ye = t()),
					(be = o('p')),
					(qe = c('Los 5 arjés. Estructura dinámica sobre la que se asienta toda la Creación.')),
					(_e = t()),
					(je = o('p')),
					(Ie = o('strong')),
			...
			l(e) {
				l(a.$$.fragment, e), (r = i(e)), (y = m(e, 'DIV', { class: !0 }));
				var s = f(y);
				b = m(s, 'DIV', { class: !0 });
				var t = f(b);
				q = m(t, 'svg', { 'fill-rule': !0, 'clip-rule': !0, viewBox: !0 }, 1);
				var o = f(q);
				(_ = m(o, 'path', { fill: !0, stroke: !0, 'stroke-width': !0, d: !0 }, 1)),
					f(_).forEach(d),
				...
				J = m(p, 'H3', {});
				var g = f(J);
				(K = $(g, 'Hacia el encuentro con todo lo que Es')),
					g.forEach(d),
					(W = i(p)),
					(X = m(p, 'H4', {}));
				var v = f(X);
				...
				te = m(h, 'DIV', { class: !0 });
				var E = f(te);
				l(oe.$$.fragment, E), E.forEach(d), (ne = i(h)), (ce = m(h, 'DIV', { class: !0 }));
				var x = f(ce);
				l(le.$$.fragment, x), (ie = i(x)), (me = m(x, 'P', {}));
				var j = f(me);
				(fe = $(
					j,
					'¿Percibes 2 ese orden 1 atravesándote 0 en la forma 4 del encuentro 3? Es lo inefable\n\t\t\tconociéndose a través de la Creación. 01234 son las llaves de tus ojos. Éstas son las cosas\n\t\t\tque yo he visto, a dónde me llevan las corrientes de todas las formas..'
				...
				(xe = $(
					...
					(be = m(D, 'P', {}));
				var k = f(be);
				(qe = $(k, 'Los 5 arjés. Estructura dinámica sobre la que se asienta toda la Creación.')),
					k.forEach(d),
					(_e = i(D)),
					(je = m(D, 'P', {}));
				var C = f(je);
			...
			h() {
				u(_, 'fill', 'none'),
					...
					u(q, 'fill-rule', 'evenodd'),
					u(q, 'clip-rule', 'evenodd'),
					u(q, 'viewBox', '0 0 193 169'),
					u(b, 'class', 'col_5'),
					u(O, 'class', 'col_13'),
					u(U, 'class', 'col_13'),
					u(N, 'class', 'dg'),
					u(M, 'class', 'col_8'),
					u(y, 'class', 'dg gap_3 p_3 bgc_primary c_4'),
					u(te, 'class', 'col_8'),
					u(ce, 'class', 'col_5 dg_0 gap_1'),
					u(ge, 'class', 'col_5 dg_0 gap_1'),
					Ve.src !== (ke = './img/01234_bn.svg') && u(Ve, 'src', './img/01234_bn.svg'),
					u(Ve, 'alt', ''),
					u(He, 'class', 'col_8'),
					u(Pe, 'class', 'col_13'),
					u(Te, 'class', 'col_13'),
					u(se, 'class', 'dg p_3 bgc_0 c_4 gap_3'),
