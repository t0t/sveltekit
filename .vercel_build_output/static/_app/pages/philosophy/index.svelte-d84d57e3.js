...
import { G as A, C as I, c as P } from '../../chunks/Cover-f3b4dc33.js';
...
function M(e) {
	...
	return {
		...
		h() {
			l(t, 'id', e[1]), l(t, 'class', (i = c(e[2][e[0]]) + ' svelte-pq1mca'));
		},
		m(e, i) {
		...
		p(e, [s]) {
			$ && $.p && 8 & s && m($, h, e, e[3], s, null, null),
				(!f || 2 & s) && l(t, 'id', e[1]),
				(!f || (1 & s && i !== (i = c(e[2][e[0]]) + ' svelte-pq1mca'))) && l(t, 'class', i);
		},
		i(e) {
			f || (d($, e), (f = !0));
		},
...
function R(e) {
	...
	return {
		...
		h() {
			l(t, 'class', (s = c(e[0] === e[3].id ? 'active' : '') + ' svelte-13vy02n'));
		},
		m(s, a) {
			u(s, t, a),
				$(t, i),
				m ||
					((d = g(t, 'click', function () {
						v(e[2](e[3].id)) && e[2](e[3].id).apply(this, arguments);
					})),
					(m = !0));
		},
		p(a, r) {
			(e = a),
				2 & r && p !== (p = e[3].title + '') && b(i, p),
				3 & r &&
					s !== (s = c(e[0] === e[3].id ? 'active' : '') + ' svelte-13vy02n') &&
					l(t, 'class', s);
		},
		d(e) {
			e && n(t), (m = !1), d();
	...
	return {
		...
		h() {
			i.src !== (s = e[3].img) && l(i, 'src', s),
				...
				l(i, 'class', 'svelte-13vy02n'),
				l(d, 'class', 'svelte-13vy02n'),
				l(t, 'slot', 'subarea1'),
				l(t, 'class', 'svelte-13vy02n');
		},
		m(e, s) {
...
function B(e) {
	...
	return {
		...
		h() {
			l(t, 'slot', 'subarea2'), l(t, 'class', 'svelte-13vy02n');
		},
		m(e, s) {
			u(e, t, s), $(t, i);
		},
		p(e, t) {
			2 & t && s !== (s = e[3].tags + '') && b(i, s);
		},
		d(e) {
			e && n(t);
		}
	...
	return {
		...
		l(e) {
			...
			(i = r(l, 'path', { fill: !0, stroke: !0, 'stroke-width': !0, d: !0 }, 1)),
				...
				o(g).forEach(n),
				(v = r(l, 'circle', { cx: !0, cy: !0, r: !0, transform: !0 }, 1)),
				o(v).forEach(n),
				l.forEach(n),
				this.h();
		},
		h() {
			l(i, 'fill', 'none'),
				...
				l(v, 'cy', '98.5'),
				l(v, 'r', '6'),
				l(v, 'transform', 'translate(-17 -8) scale(.67024)'),
...
function ie(e) {
	...
	return {
		...
		m(e, a) {
			u(e, t, a), $(t, i), $(i, s), $(t, c), $(t, m), $(m, d), $(t, p), $(t, g), $(g, v);
		},
		d(e) {
			e && n(t);
		}
