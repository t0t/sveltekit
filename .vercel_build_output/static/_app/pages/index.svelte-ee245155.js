...
import { c as O, B as L } from '../chunks/Grid.svelte-1b56dd60.js';
import { s as R } from '../chunks/pages-cee8d843.js';
import { H } from '../chunks/Header-bbb40db3.js';
import { L as W, a as C } from '../chunks/ListItem-13a8e652.js';
import { B as F } from '../chunks/Blockquote-643c6c00.js';
import { f as G } from '../chunks/index-65311448.js';
import { I as Q } from '../chunks/Img-1aaa5537.js';
...
function U(t) {
	...
	return {
		c() {
			(e = s('q')), (a = v(t[0])), (n = b()), (l = s('br')), this.h();
		},
		l(s) {
			e = r(s, 'Q', { class: !0 });
			var i = o(e);
			(a = _(i, t[0])), i.forEach(c), (n = k(s)), (l = r(s, 'BR', { class: !0 })), this.h();
		},
		h() {
			i(e, 'class', 'svelte-1ao2o1r'), i(l, 'class', 'svelte-1ao2o1r');
		},
		m(t, s) {
			h(t, e, s), y(e, a), h(t, n, s), h(t, l, s);
		},
		p(t, e) {
			1 & e && q(a, t[0]);
		},
...
function J(t) {
	...
	return {
		...
		l(s) {
			...
			var l = o(e);
			(a = _(l, '— ')), (n = _(l, t[1])), l.forEach(c), this.h();
		},
		h() {
			i(e, 'slot', 'author'), i(e, 'class', 'svelte-1ao2o1r');
		},
		m(t, s) {
			h(t, e, s), y(e, a), y(e, n);
		},
...
function K(t) {
	...
	return (
		(a = new F({ props: { $$slots: { author: [J], default: [U] }, $$scope: { ctx: t } } })),
		{
			...
			h() {
				i(e, 'class', 'mySlides svelte-1ao2o1r'), u(e, 'background-image', 'url(' + t[2] + ')');
			},
			m(t, s) {
				h(t, e, s), $(a, e, null), (b = !0);
			},
			p(t, [s]) {
				const n = {};
			...
			o(t) {
				p(a.$$.fragment, t), v || (v = g(e, G, {}, !1)), v.run(0), (b = !1);
			},
			d(t) {
				t && c(e), d(a), t && v && v.end();
			}
...
function tt(t) {
	...
	return {
		c() {
			(e = s('div')), (a = s('label')), (n = s('input')), (l = b()), (u = s('span')), this.h();
		},
		l(t) {
		...
		h() {
			i(n, 'type', 'checkbox'),
				i(n, 'class', 'svelte-dgkjbt'),
				i(u, 'class', 'slider round svelte-dgkjbt'),
				i(a, 'class', 'switch svelte-dgkjbt'),
				i(e, 'class', 'switch-cont svelte-dgkjbt'),
		...
		m(s, r) {
			h(s, e, r),
				...
				y(a, l),
				y(a, u),
				$ || ((f = [w(n, 'change', t[2]), w(n, 'change', t[1])]), ($ = !0));
		},
		p(t, [e]) {
			1 & e && (n.checked = t[0]);
		},
	...
	return (
		...
		H.$on('change', t[8]),
		{
			...
			l(t) {
				e = r(t, 'DIV', { class: !0 });
				var a = o(e);
				U.l(a), (u = k(a)), (m = r(a, 'SPAN', { href: !0, class: !0, title: !0 }));
				var s = o(m);
				(g = _(s, '❮')),
					s.forEach(c),
					(q = k(a)),
					(I = r(a, 'SPAN', { href: !0, class: !0, title: !0 }));
				var n = o(I);
				(A = _(n, '❯')), n.forEach(c), (O = k(a)), (L = r(a, 'DIV', { class: !0 }));
				var i = o(L);
			...
			h() {
				i(m, 'href', '#prev'),
					i(m, 'class', 'prev svelte-11dijip'),
					i(m, 'title', 'previous quote'),
					x(m, 'not-clickable', t[2]),
					i(I, 'href', '#next'),
					i(I, 'class', 'next svelte-11dijip'),
					i(I, 'title', 'next quote'),
					x(I, 'not-clickable', t[2]),
					i(L, 'class', 'dot-container svelte-11dijip'),
					i(e, 'class', 'slideshow-container svelte-11dijip');
			},
			m(a, s) {
				h(a, e, s),
					U.m(e, null),
				...
				y(L, R),
					$(H, L, null),
					(C = !0),
					F || ((G = [w(m, 'click', t[7]), w(I, 'click', t[6])]), (F = !0));
			},
			p(t, [s]) {
				if (
					(32 & s && a(Q, (Q = t[5]))
						? (N(), p(U, 1, 1, j), V(), (U = nt(t)), U.c(), f(U), U.m(e, u))
						: U.p(t, s),
					4 & s && x(m, 'not-clickable', t[2]),
					4 & s && x(I, 'not-clickable', t[2]),
					5 & s)
				) {
					let e;
					...
					for (N(), e = J.length; e < K.length; e += 1) z(e);
					V();
				}
				const n = {};
...
function ut(t) {
	...
	return {
		c() {
			(e = v(f)), (a = b()), (n = s('br')), (l = s('span')), (u = v(m)), ($ = b()), this.h();
		},
		l(t) {
			(e = _(t, f)), (a = k(t)), (n = r(t, 'BR', { class: !0 })), (l = r(t, 'SPAN', { class: !0 }));
			var s = o(l);
			(u = _(s, m)), s.forEach(c), ($ = k(t)), this.h();
		},
		h() {
			i(n, 'class', 'svelte-1asiahq'), i(l, 'class', 'svelte-1asiahq');
		},
		m(t, s) {
			h(t, e, s), h(t, a, s), h(t, n, s), h(t, l, s), y(l, u), h(t, $, s);
		},
		p(t, a) {
			1 & a && f !== (f = t[4] + '') && q(e, f), 1 & a && m !== (m = t[5] + '') && q(u, m);
		},
		d(t) {
			t && c(e), t && c(a), t && c(n), t && c(l), t && c($);
		}
	};
}
function ht(t) {
...
function pt(t) {
	let e, a, u, m, g, v, _, q, x, w, I, E, P, D, N, V, B, S, A, W, C, G;
	return (
		(u = new H({
		...
		(V = new Q({ props: { variante: 1, src: './img/02234-14.jpg', alt: 'Presentation' } })),
		(A = new F({
			props: {
				variante: 1,
		...
		})),
		{
			...
			l(t) {
				...
				a = r(s, 'DIV', { class: !0 });
				var n = o(a);
				l(u.$$.fragment, n), n.forEach(c), (m = k(s)), (g = r(s, 'DIV', { class: !0 }));
				var i = o(g);
				l(v.$$.fragment, i), i.forEach(c), (_ = k(s)), (q = r(s, 'DIV', { class: !0 }));
				var h = o(q);
				l(x.$$.fragment, h),
					h.forEach(c),
					s.forEach(c),
				...
				E = r($, 'DIV', { class: !0 });
				var f = o(E);
				l(P.$$.fragment, f), f.forEach(c), (D = k($)), (N = r($, 'DIV', { class: !0 }));
				var p = o(N);
				l(V.$$.fragment, p),
					p.forEach(c),
					$.forEach(c),
					...
					(S = r(t, 'DIV', { class: !0 }));
				var d = o(S);
				l(A.$$.fragment, d), (W = k(d)), l(C.$$.fragment, d), d.forEach(c), this.h();
			},
			h() {
				i(a, 'class', ' bgc_primary c_5 mh_3 dg_0 pcc col_13 col_s2_5 '),
					i(g, 'class', 'col_13 col_s2_8'),
					i(q, 'class', 'col_13 mh_5'),
					i(e, 'class', 'dg'),
					i(E, 'class', 'col_13 col_s2_8 c_5 tac'),
					i(N, 'class', 'col_13 col_s2_5 '),
					i(I, 'class', 'dg p_3 bgc_primary rg_1'),
