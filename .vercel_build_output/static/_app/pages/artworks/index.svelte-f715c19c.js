...
import { B as L, G as N, C, c as M } from '../../chunks/Cover-baa7aeae.js';
...
function Q(t) {
	...
	return {
		...
		l(a) {
			...
			var u = o(x);
			(w = l(u, t[0])), u.forEach(c), (I = m(s)), (E = n(s, 'A', { href: !0, class: !0 }));
			var d = o(E);
			(P = l(d, '❯')), d.forEach(c), s.forEach(c), this.h();
		},
		h() {
			u(i, 'href', '#arrowL'),
				u(i, 'class', 'arrow prev svelte-1v6a460'),
				u(x, 'id', 'caption'),
				u(x, 'class', 'svelte-1v6a460'),
				u(E, 'href', '#arrowR'),
				u(E, 'class', 'arrow next svelte-1v6a460'),
				u(e, 'class', 'caption-container svelte-1v6a460');
		},
		m(a, s) {
			d(a, e, s),
				$(e, i),
...
function X(t) {
	...
	return {
		...
		h() {
			u(i, 'class', 'close cursor svelte-1nbtli4'),
				u(L, 'class', 'Thumbnails svelte-1nbtli4'),
				u(e, 'class', 'lightbox svelte-1nbtli4');
		},
		m(a, s) {
			d(a, e, s),
				$(e, i),
		...
		o(t) {
			D(f.$$.fragment, t), D(b.$$.fragment, t), (O = O.filter(Boolean));
			for (let e = 0; e < O.length; e += 1) D(O[e]);
			N && N.invalidate(), (C = T(e, z, {})), (M = !1);
		},
		d(t) {
			t && c(e), k(f), k(b), j(O, t), t && C && C.end(), (R = !1), U();
		}
	};
}
function tt(t, e, i) {
	...
	return (
		...
		(t.$$.update = () => {
			1 & t.$$.dirty && console.log(s), 1 & t.$$.dirty && i(1, (a = A[s]));
		}),
		[
			s,
			a,
...
function ct(t) {
	...
	return (
		...
		$.$on('click', t[4]),
		{
			...
			m(t, i) {
				f[e].m(t, i), d(t, s, i), d(t, l, i), E($, l, null), (p = !0);
			},
			p(t, [a]) {
				let r = e;
				(e = h(t)),
...
function kt(t) {
	...
	return (
		...
		})),
		{
			...
			m(t, a) {
				d(t, e, a), E(i, e, null), (s = !0);
			},
			p: g,
			i(t) {
				s || (P(i.$$.fragment, t), (s = !0));
			},
			o(t) {
				D(i.$$.fragment, t), (s = !1);
			},
