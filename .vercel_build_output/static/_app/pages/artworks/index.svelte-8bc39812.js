...
import { B as N, c as C } from '../../chunks/Grid.svelte-f6369e02.js';
import { T as L } from '../../chunks/Tabs-ea9ec3d7.js';
import { t as G } from '../../chunks/miProceso-ec715937.js';
import { a as H, f as U } from '../../chunks/index-65311448.js';
import { H as q } from '../../chunks/Header-33a8b362.js';
import { I as A } from '../../chunks/Img-4bbf7ce3.js';
import { S as B } from '../../chunks/Section-ebe14856.js';
import { B as M } from '../../chunks/Blockquote-7c22a2d7.js';
import '../../chunks/ListItem-50336afd.js';
...
function O(e) {
	...
	return {
		...
		h() {
			$(a, 'class', 'numbertext svelte-11xa73v'),
				x.src !== (w = e[2]) && $(x, 'src', w),
				$(x, 'alt', e[3]),
				$(x, 'title', e[4]),
				$(x, 'class', 'svelte-11xa73v'),
				$(t, 'class', 'Slide svelte-11xa73v');
		},
		m(e, n) {
...
class W extends e {
	constructor(e) {
		super(),
			t(this, e, z, O, a, { slideNo: 0, totalSlides: 1, image: 2, altTag: 3, description: 4 });
	}
}
function F(e) {
	let t, a, s, r;
	return {
		...
		h() {
			$(t, 'class', 'sample cursor svelte-1sjkkcr'),
				$(t, 'id', e[3]),
				t.src !== (a = e[0]) && $(t, 'src', a),
				$(t, 'alt', e[1]),
				$(t, 'title', e[2]),
...
function Q(e) {
	...
	return {
		...
		l(n) {
			...
			var r = c(a);
			(u = l(r, '❮')), r.forEach(o), (v = m(s)), (x = i(s, 'P', { id: !0, class: !0 }));
			var $ = c(x);
			(w = l($, e[0])), $.forEach(o), (_ = m(s)), (I = i(s, 'A', { href: !0, class: !0 }));
			var g = c(I);
			(k = l(g, '❯')), g.forEach(o), s.forEach(o), this.h();
		},
		h() {
			$(a, 'href', '#arrowL'),
				$(a, 'class', 'arrow prev svelte-nie9f1'),
				$(x, 'id', 'caption'),
				$(x, 'class', 'svelte-nie9f1'),
				$(I, 'href', '#arrowR'),
				$(I, 'class', 'arrow next svelte-nie9f1'),
				$(t, 'class', 'caption-container svelte-nie9f1');
		},
		m(n, s) {
			g(n, t, s),
				d(t, a),
...
function te(e) {
	let t, a, f, p, u, v, b, x, N, C, L, G, q, A;
	(u = new W({
		props: {
			image: e[1].imgurl,
			altTag: e[1].name,
	...
	return {
		...
		l(e) {
			...
			r.forEach(o), n.forEach(o), this.h();
		},
		h() {
			$(a, 'class', 'close cursor svelte-cp1fk3'),
				$(N, 'class', 'Thumbnails svelte-cp1fk3'),
				$(t, 'class', 'lightbox svelte-cp1fk3');
		},
		m(n, s) {
			g(n, t, s),
				d(t, a),
		...
		i(e) {
			if (!G) {
				...
				S(() => {
					L && L.end(1), C || (C = y(t, H, { x: -300 })), C.start();
				}),
					(G = !0);
			}
		},
		o(e) {
			...
			C && C.invalidate(), (L = V(t, U, {})), (G = !1);
		},
		d(e) {
			e && o(t), E(u), E(b), T(M, e), e && L && L.end(), (q = !1), A();
		}
	};
}
function ae(e, t, a) {
...
function ie(e) {
	...
	return {
		...
		h() {
			$(t, 'class', 'DemoGallery svelte-s7w3i6');
		},
		m(e, a) {
			g(e, t, a);
...
function $e(e) {
	...
	return (
		...
		{
			c() {
				a.c(), (s = r()), (l = n('aside')), w(d.$$.fragment), this.h();
			},
			l(e) {
				a.l(e), (s = m(e)), (l = i(e, 'ASIDE', { class: !0 }));
				var t = c(l);
				_(d.$$.fragment, t), t.forEach(o), this.h();
			},
			h() {
				$(l, 'class', 'svelte-arr6cz');
			},
			m(e, a) {
				u[t].m(e, a), g(e, s, a), g(e, l, a), I(d, l, null), (f = !0);
			},
			p(e, [n]) {
				let r = t;
				(t = h(e)),
	...
	return {
		...
		h() {
			r.src !== (m = '/img/desdelapoesiadelamateria.webm') &&
				...
				(a.playsInline = !0),
				(a.controls = 'controls'),
				$(t, 'class', 'video-wrapper svelte-1vnv3v8');
		},
		m(e, n) {
...
function ue(e) {
	let t, a, s, l, f, u, h, v, b, x;
	return (
		(s = new q({ props: { tipo: 2, variante: 5, title: C[1].title, subtitle: C[1].subtitle } })),
		(u = new pe({})),
		(b = new M({
			props: {
				variante: 1,
		...
		})),
		{
			...
			l(e) {
				...
				a = i(n, 'DIV', { class: !0 });
				var r = c(a);
				_(s.$$.fragment, r), r.forEach(o), (l = m(n)), (f = i(n, 'DIV', { class: !0 }));
				var $ = c(f);
				_(u.$$.fragment, $), $.forEach(o), (h = m(n)), (v = i(n, 'DIV', { class: !0 }));
				var g = c(v);
				_(b.$$.fragment, g), g.forEach(o), n.forEach(o), this.h();
			},
			h() {
...
function he(e) {
	let t, a, n, s;
	return (
		(t = new q({ props: { tipo: 1, variante: 3, title: 'Galería' } })),
		(n = new de({})),
		{
			c() {
	...
	return (
		...
		})),
		{
			...
			l(e) {
				...
				_(s.$$.fragment, r), r.forEach(o), (l = m(n)), (f = i(n, 'DIV', { class: !0 }));
				var $ = c(f);
				_(u.$$.fragment, $), $.forEach(o), n.forEach(o), this.h();
			},
			h() {
			...
			m(e, n) {
				g(e, t, n), d(t, a), I(s, a, null), d(t, l), d(t, f), I(u, f, null), (h = !0);
			},
			p: p,
			i(e) {
	...
	return (
		...
		})),
		{
			...
			l(e) {
				t = i(e, 'DIV', { class: !0 });
				var n = c(t);
				_(a.$$.fragment, n), n.forEach(o), (s = m(e)), (l = i(e, 'DIV', { class: !0 }));
				var r = c(l);
				f = i(r, 'DIV', { class: !0 });
				var $ = c(f);
				_(u.$$.fragment, $), $.forEach(o), (h = m(r)), _(v.$$.fragment, r), r.forEach(o), this.h();
			},
			h() {
				$(t, 'class', 'col_13'),
					$(f, 'class', 'mw_7'),
					$(l, 'class', 'col_13 mh_0 dg_0 pt_3 pb_3 tac bgc_0 pcc_0 c_3 mh_s2_5 rg_1');
			},
			m(e, n) {
				g(e, t, n),
					I(a, t, null),
			...
			d(e) {
				e && o(t), E(a), e && o(s), e && o(l), E(u), E(v);
			}
		}
	);
}
function we(e) {
	let t, a, n, s, i, c, l, $, d, f;
	return (
		(t = new B({
		...
		(i = new B({ props: { variante: 1, $$slots: { default: [ve] }, $$scope: { ctx: e } } })),
		(l = new B({
			props: { id: 'proceso', variante: 2, $$slots: { default: [be] }, $$scope: { ctx: e } }
		})),
		(d = new B({ props: { variante: 1, $$slots: { default: [xe] }, $$scope: { ctx: e } } })),
		{
			c() {
				w(t.$$.fragment),
					(a = r()),
			...
			p(e, [a]) {
				...
				const o = {};
				1 & a && (o.$$scope = { dirty: a, ctx: e }), l.$set(o);
				const m = {};
			...
			d(e) {
				E(t, e), e && o(a), E(n, e), e && o(s), E(i, e), e && o(c), E(l, e), e && o($), E(d, e);
			}
		}
	);
}
