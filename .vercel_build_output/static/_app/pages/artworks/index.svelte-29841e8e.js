...
import { T as V } from '../../chunks/Tabs-f87287a6.js';
import { a as z, f as N } from '../../chunks/index-65311448.js';
import { B as A, G } from '../../chunks/ListItem-e194f349.js';
import { S as R, H as U } from '../../chunks/Header-a9ed1c92.js';
import { I as M } from '../../chunks/Img-3fbf0e6b.js';
import '../../chunks/List-23857782.js';
...
function W(e) {
	...
	return {
		...
		h() {
			d(a, 'class', 'numbertext svelte-jn23c1'),
				x.src !== (q = e[2]) && d(x, 'src', q),
				d(x, 'alt', e[3]),
				d(x, 'title', e[4]),
				d(x, 'class', 'svelte-jn23c1'),
				d(t, 'class', 'Slide svelte-jn23c1');
		},
		m(e, i) {
			u(e, t, i), g(t, a), g(a, f), g(a, h), g(a, v), g(t, b), g(t, x);
		},
		p(e, [t]) {
			1 & t && p(f, e[0]),
				2 & t && p(v, e[1]),
				4 & t && x.src !== (q = e[2]) && d(x, 'src', q),
				8 & t && d(x, 'alt', e[3]),
				16 & t && d(x, 'title', e[4]);
		},
		i: $,
...
function _(e, t, a) {
	...
	return (
		(e.$$set = (e) => {
			'slideNo' in e && a(0, (i = e.slideNo)),
				'totalSlides' in e && a(1, (n = e.totalSlides)),
				'image' in e && a(2, (s = e.image)),
				'altTag' in e && a(3, (r = e.altTag)),
				'description' in e && a(4, (o = e.description));
		}),
		[i, n, s, r, o]
	);
}
class B extends e {
	constructor(e) {
		super(),
			t(this, e, _, W, a, { slideNo: 0, totalSlides: 1, image: 2, altTag: 3, description: 4 });
	}
}
function F(e) {
	let t, a, n, s;
	return {
		...
		l(e) {
			(t = r(e, 'IMG', { class: !0, id: !0, src: !0, alt: !0, title: !0 })), this.h();
		},
		h() {
			d(t, 'class', 'sample cursor svelte-agngq9'),
				d(t, 'id', e[3]),
				t.src !== (a = e[0]) && d(t, 'src', a),
				d(t, 'alt', e[1]),
				d(t, 'title', e[2]),
				f(t, 'active', e[4]);
		},
		m(a, i) {
			u(a, t, i), n || ((s = h(t, 'click', e[5])), (n = !0));
		},
		p(e, [i]) {
			8 & i && d(t, 'id', e[3]),
				1 & i && t.src !== (a = e[0]) && d(t, 'src', a),
				2 & i && d(t, 'alt', e[1]),
				4 & i && d(t, 'title', e[2]),
				16 & i && f(t, 'active', e[4]);
		},
...
function K(e, t, a) {
	...
	return (
		(e.$$set = (e) => {
			'thumbImg' in e && a(0, (i = e.thumbImg)),
				'altTag' in e && a(1, (n = e.altTag)),
				'titleLink' in e && a(2, (s = e.titleLink)),
				'id' in e && a(3, (r = e.id)),
				'selected' in e && a(4, (o = e.selected));
		}),
		[
			i,
			n,
...
class J extends e {
	constructor(e) {
		super(), t(this, e, K, F, a, { thumbImg: 0, altTag: 1, titleLink: 2, id: 3, selected: 4 });
	}
}
function Q(e) {
	let t, a, f, v, x, q, E, y, w, j, I;
	return {
		c() {
			(t = i('div')),
				(a = i('a')),
		...
		l(i) {
			t = r(i, 'DIV', { class: !0 });
			var n = o(t);
			a = r(n, 'A', { href: !0, class: !0 });
			var s = o(a);
			(f = l(s, '❮')), s.forEach(c), (v = m(n)), (x = r(n, 'P', { id: !0, class: !0 }));
			var d = o(x);
			(q = l(d, e[0])), d.forEach(c), (E = m(n)), (y = r(n, 'A', { href: !0, class: !0 }));
			var u = o(y);
			(w = l(u, '❯')), u.forEach(c), n.forEach(c), this.h();
		},
		h() {
			d(a, 'href', '#arrowL'),
				d(a, 'class', 'arrow prev svelte-1xsk9tw'),
				d(x, 'id', 'caption'),
				d(x, 'class', 'svelte-1xsk9tw'),
				d(y, 'href', '#arrowR'),
				d(y, 'class', 'arrow next svelte-1xsk9tw'),
				d(t, 'class', 'caption-container svelte-1xsk9tw');
		},
		m(i, n) {
			u(i, t, n),
				g(t, a),
				...
				g(t, y),
				g(y, w),
				j || ((I = [h(a, 'click', e[2]), h(y, 'click', e[3])]), (j = !0));
		},
		p(e, [t]) {
			1 & t && p(q, e[0]);
		},
...
function X(e, t, a) {
	const i = e.slice();
	return (i[7] = t[a].id), (i[8] = t[a].imgurl), (i[9] = t[a].name), i;
}
function ee(e) {
	let t, a;
	return (
		...
		}),
		{
			...
			p(a, i) {
				e = a;
				const n = {};
				1 & i && (n.selected = Number(e[0]) === e[7]), t.$set(n);
			},
			i(e) {
				a || (w(t.$$.fragment, e), (a = !0));
			},
			o(e) {
				j(t.$$.fragment, e), (a = !1);
			},
...
function te(e) {
	...
	let M = O,
		H = [];
	for (let i = 0; i < M.length; i += 1) H[i] = ee(X(e, M, i));
	const W = (e) =>
		j(H[e], 1, 1, () => {
			H[e] = null;
		});
	return {
		...
		l(e) {
			...
			(p = l(n, '✗')),
				...
				(C = r(i, 'DIV', { class: !0 }));
			var s = o(C);
			for (let t = 0; t < H.length; t += 1) H[t].l(s);
			s.forEach(c), i.forEach(c), this.h();
		},
		h() {
			d(a, 'class', 'close cursor svelte-vnpm79'),
				d(C, 'class', 'Thumbnails svelte-vnpm79'),
				d(t, 'class', 'lightbox svelte-vnpm79');
		},
		m(i, n) {
			u(i, t, n),
				g(t, a),
		...
		p(e, [t]) {
			...
			2 & t && (a.image = e[1].imgurl),
				...
				f.$set(a);
			const i = {};
			if ((1 & t && (i.caption = O[e[0]].description), b.$set(i), 17 & t)) {
				let a;
				for (M = O, a = 0; a < M.length; a += 1) {
					const i = X(e, M, a);
					H[a]
						? (H[a].p(i, t), w(H[a], 1))
						: ((H[a] = ee(i)), H[a].c(), w(H[a], 1), H[a].m(C, null));
				}
				for (P(), a = M.length; a < H.length; a += 1) W(a);
				D();
			}
		},
		i(e) {
			if (!G) {
				...
				for (let e = 0; e < M.length; e += 1) w(H[e]);
				k(() => {
					A && A.end(1), V || (V = L(t, z, { x: -300 })), V.start();
				}),
					(G = !0);
			}
		},
		o(e) {
			...
			for (let t = 0; t < H.length; t += 1) j(H[t]);
			V && V.invalidate(), (A = T(t, N, {})), (G = !1);
		},
		d(e) {
			e && c(t), I(f), I(b), S(H, e), e && A && A.end(), (R = !1), U();
		}
	};
}
function ae(e, t, a) {
	let i,
		{ imageShowingIndex: n = 0 } = t;
	const s = (e) => a(0, (n = Number(e)));
	return (
		(e.$$set = (e) => {
			'imageShowingIndex' in e && a(0, (n = e.imageShowingIndex));
		}),
		(e.$$.update = () => {
			1 & e.$$.dirty && a(1, (i = O[n]));
		}),
		[
			...
			i,
			() => {
				a(0, n === O.length - 1 ? (n = 0) : (n += 1));
			},
			() => {
				a(0, 0 === n ? (n = O.length - 1) : (n -= 1));
			},
			s,
			function (t) {
				v(e, t);
...
function ne(e, t, a) {
	const i = e.slice();
	return (i[1] = t[a].id), (i[2] = t[a].imgurl), (i[3] = t[a].name), i;
}
function se(e) {
	let t, a, n, s;
	return {
		...
		l(e) {
			(t = r(e, 'IMG', { id: !0, src: !0, alt: !0, class: !0 })), this.h();
		},
		h() {
			d(t, 'id', e[1]),
				t.src !== (a = e[2]) && d(t, 'src', a),
				d(t, 'alt', e[3]),
				d(t, 'class', 'svelte-q3c5h8');
		},
		m(a, i) {
			u(a, t, i), n || ((s = h(t, 'click', e[0])), (n = !0));
		},
		p: $,
		d(e) {
			e && c(t), (n = !1), s();
...
function re(e) {
	let t,
		a = O,
		n = [];
	for (let i = 0; i < a.length; i += 1) n[i] = se(ne(e, a, i));
	return {
		c() {
			t = i('div');
		...
		h() {
			d(t, 'class', 'DemoGallery svelte-q3c5h8');
		},
		m(e, a) {
			u(e, t, a);
		...
		p(e, [i]) {
			if (0 & i) {
				let s;
				for (a = O, s = 0; s < a.length; s += 1) {
					const r = ne(e, a, s);
					n[s] ? n[s].p(r, i) : ((n[s] = se(r)), n[s].c(), n[s].m(t, null));
				}
...
function me(e) {
	let t, a;
	return (
		(t = new ie({ props: { imageShowingIndex: e[1] } })),
		t.$on('click', e[3]),
		{
			c() {
				q(t.$$.fragment);
			...
			p(e, a) {
				const i = {};
				2 & a && (i.imageShowingIndex = e[1]), t.$set(i);
			},
			i(e) {
				a || (w(t.$$.fragment, e), (a = !0));
			},
...
function de(e) {
	...
	return (
		...
		{
			c() {
				a.c(), (n = s()), (l = i('aside')), q(g.$$.fragment), this.h();
			},
			l(e) {
				a.l(e), (n = m(e)), (l = r(e, 'ASIDE', { class: !0 }));
				var t = o(l);
				E(g.$$.fragment, t), t.forEach(c), this.h();
			},
			h() {
				d(l, 'class', 'svelte-t3d9c9');
			},
			m(e, a) {
				f[t].m(e, a), u(e, n, a), u(e, l, a), y(g, l, null), (p = !0);
			},
			p(e, [i]) {
				let s = t;
				(t = h(e)),
					t === s
						...
						: (P(),
						  ...
						  D(),
						  (a = f[t]),
						  a ? a.p(e, i) : ((a = f[t] = $[t](e)), a.c()),
						  w(a, 1),
						  a.m(n.parentNode, n));
			},
			i(e) {
				p || (w(a), w(g.$$.fragment, e), (p = !0));
			},
			o(e) {
				j(a), j(g.$$.fragment, e), (p = !1);
			},
			d(e) {
				f[t].d(e), e && c(n), e && c(l), I(g);
			}
		}
	);
}
function ue(e, t, a) {
	...
	return [
		...
		n,
		(e) => {
			a(1, (n = Number(e.target.id))), a(0, (i = !0));
		},
		() => a(0, (i = !1)),
		() => a(0, (i = !0))
	];
	...
	return {
		c() {
			(t = i('video')),
				...
				(m = i('source')),
				($ = i('p')),
				(f = n('Ups! Su navegador no soporta vídeos HTML5.')),
				this.h();
		},
		l(e) {
			t = r(e, 'VIDEO', { poster: !0, loop: !0, playsinline: !0, controls: !0 });
			var i = o(t);
			(a = r(i, 'SOURCE', { src: !0, type: !0 })),
				(m = r(i, 'SOURCE', { src: !0, type: !0 })),
				($ = r(i, 'P', {}));
			var n = o($);
			(f = l(n, 'Ups! Su navegador no soporta vídeos HTML5.')),
				n.forEach(c),
				i.forEach(c),
				this.h();
		},
		h() {
			a.src !== (s = '/img/desdelapoesiadelamateria.webm') &&
				d(a, 'src', '/img/desdelapoesiadelamateria.webm'),
				d(a, 'type', 'video/webm'),
...
function $e(e) {
	...
	return {
		c() {
			(t = i('div')), (a = i('p')), (s = n('Desde la poesía de la materia')), this.h();
		},
		l(e) {
			t = r(e, 'DIV', { slot: !0 });
			var i = o(t);
			a = r(i, 'P', {});
			var n = o(a);
			(s = l(n, 'Desde la poesía de la materia')), n.forEach(c), i.forEach(c), this.h();
		},
		h() {
			d(t, 'slot', 'subarea1');
		},
...
function he(e) {
	...
	return (
		...
		})),
		{
			...
			p(e, [a]) {
				const i = {};
				1 & a && (i.$$scope = { dirty: a, ctx: e }), t.$set(i);
			},
			i(e) {
				a || (w(t.$$.fragment, e), (a = !0));
			},
...
function ye(e) {
	...
	return {
		...
		l(e) {
			(t = r(e, 'IMG', { src: !0, alt: !0 })), this.h();
		},
		h() {
			t.src !== (a = './img/grafico-8.svg') && d(t, 'src', './img/grafico-8.svg'), d(t, 'alt', '');
		},
		m(e, a) {
			u(e, t, a);
		},
...
function je(e) {
	...
	return {
		...
		m(e, i) {
			u(e, t, i), g(t, a), g(a, p), g(t, $), g(t, f), g(f, h);
		},
		d(e) {
			e && c(t);
		}
...
function Ie(e) {
	...
	return (
		(t = new G({
			props: {
				variante: 2,
				$$slots: { subarea2: [je], subarea1: [we], default: [ye] },
				$$scope: { ctx: e }
			}
		})),
		{
...
function Pe(e) {
	let t, a;
	return (
		(t = new M({ props: { variante: 4, src: './img/cover4.jpg', alt: 'Presentation' } })),
		{
			c() {
				q(t.$$.fragment);
			},
		...
		})),
		{
			c() {
				(t = i('div')),
					...
					(p = s()),
					(f = i('p')),
					(h = n('Puedes obtener más información contactándome en las redes o por Whatsapp')),
					this.h();
			},
			l(e) {
				t = r(e, 'DIV', { slot: !0 });
				var i = o(t);
				E(a.$$.fragment, i), (p = m(i)), (f = r(i, 'P', {}));
				var n = o(f);
				(h = l(n, 'Puedes obtener más información contactándome en las redes o por Whatsapp')),
					n.forEach(c),
					i.forEach(c),
					this.h();
			},
			...
			m(e, i) {
				u(e, t, i), y(a, t, null), g(t, p), g(t, f), g(f, h), (v = !0);
			},
			p: $,
			i(e) {
				v || (w(a.$$.fragment, e), (v = !0));
			},
			o(e) {
				j(a.$$.fragment, e), (v = !1);
			},
...
function ke(e) {
	...
	return (
		...
		{
			c() {
				(t = i('div')), q(a.$$.fragment), this.h();
			},
			l(e) {
				t = r(e, 'DIV', { slot: !0 });
				var i = o(t);
				E(a.$$.fragment, i), i.forEach(c), this.h();
			},
			h() {
				d(t, 'slot', 'subarea1');
			},
			m(e, i) {
				u(e, t, i), y(a, t, null), (n = !0);
			},
			p: $,
			i(e) {
				n || (w(a.$$.fragment, e), (n = !0));
			},
			o(e) {
				j(a.$$.fragment, e), (n = !1);
			},
...
function Le(e) {
	...
	return (
		(t = new G({
			props: {
				variante: 5,
				$$slots: { subarea1: [ke], subarea2: [De], default: [Pe] },
				$$scope: { ctx: e }
			}
		})),
		{
...
function Te(e) {
	let t, a, i, n, r, o, l, d, g, p, $, f, h, v, b, x;
	return (
		(t = new R({
		...
		(r = new U({ props: { tipo: 1, variante: 4, title: 'Galería' } })),
		(l = new R({
			props: {
				id: 'lightboxgallery',
				variante: 0,
		...
		(h = new R({ props: { variante: 4, $$slots: { default: [Ie] }, $$scope: { ctx: e } } })),
		(b = new R({ props: { variante: 3, $$slots: { default: [Le] }, $$scope: { ctx: e } } })),
		{
			c() {
				q(t.$$.fragment),
					(a = s()),
			...
			p(e, [a]) {
				...
				const s = {};
				1 & a && (s.$$scope = { dirty: a, ctx: e }), i.$set(s);
				const r = {};
				1 & a && (r.$$scope = { dirty: a, ctx: e }), l.$set(r);
				const o = {};
				1 & a && (o.$$scope = { dirty: a, ctx: e }), $.$set(o);
				const c = {};
				1 & a && (c.$$scope = { dirty: a, ctx: e }), h.$set(c);
				const m = {};
				1 & a && (m.$$scope = { dirty: a, ctx: e }), b.$set(m);
			},
			i(e) {
				x ||
					(w(t.$$.fragment, e),
