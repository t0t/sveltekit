...
import { c as O, B as L } from '../chunks/Grid.svelte-916f7747.js';
import { s as R } from '../chunks/pages-cee8d843.js';
import { H } from '../chunks/Header-cd15ff25.js';
import { L as W, a as C } from '../chunks/ListItem-cf78d2b1.js';
import { B as F } from '../chunks/Blockquote-779c1cb4.js';
import { f as G } from '../chunks/index-65311448.js';
import { I as Q } from '../chunks/Img-fdbb3f27.js';
...
function U(t) {
	...
	return {
		...
		l(s) {
			e = r(s, 'Q', { class: !0 });
			var i = o(e);
			(a = _(i, t[0])), i.forEach(l), (n = y(s)), (c = r(s, 'BR', { class: !0 })), this.h();
		},
		h() {
			i(e, 'class', 'svelte-etc2be'), i(c, 'class', 'svelte-etc2be');
		},
		m(t, s) {
			h(t, e, s), x(e, a), h(t, n, s), h(t, c, s);
		},
		p(t, e) {
			1 & e && k(a, t[0]);
		},
...
function J(t) {
	...
	return {
		...
		l(s) {
			...
			var c = o(e);
			(a = _(c, '— ')), (n = _(c, t[1])), c.forEach(l), this.h();
		},
		h() {
			i(e, 'slot', 'author'), i(e, 'class', 'svelte-etc2be');
		},
		m(t, s) {
			h(t, e, s), x(e, a), x(e, n);
		},
...
function K(t) {
	...
	return (
		(a = new F({ props: { $$slots: { author: [J], default: [U] }, $$scope: { ctx: t } } })),
		{
			...
			h() {
				i(e, 'class', 'mySlides svelte-etc2be'), u(e, 'background-image', 'url(' + t[2] + ')');
			},
			m(t, s) {
...
function tt(t) {
	...
	return {
		...
		h() {
			i(n, 'type', 'checkbox'),
				i(n, 'class', 'svelte-drv5cw'),
				i(u, 'class', 'slider round svelte-drv5cw'),
				i(a, 'class', 'switch svelte-drv5cw'),
				i(e, 'class', 'switch-cont svelte-drv5cw'),
		...
		m(s, r) {
			h(s, e, r),
				...
				x(a, c),
				x(a, u),
				f || (($ = [q(n, 'change', t[2]), q(n, 'change', t[1])]), (f = !0));
		},
		p(t, [e]) {
			1 & e && (n.checked = t[0]);
		},
	...
	return (
		...
		H.$on('change', t[8]),
		{
			...
			l(t) {
				e = r(t, 'DIV', { class: !0 });
				var a = o(e);
				U.l(a), (u = y(a)), (m = r(a, 'SPAN', { href: !0, class: !0, title: !0 }));
				var s = o(m);
				(g = _(s, '❮')),
					s.forEach(l),
					(k = y(a)),
				...
				var n = o(E);
				(A = _(n, '❯')), n.forEach(l), (O = y(a)), (L = r(a, 'DIV', { class: !0 }));
				var i = o(L);
				for (let e = 0; e < K.length; e += 1) K[e].l(i);
				(R = y(i)), c(H.$$.fragment, i), i.forEach(l), a.forEach(l), this.h();
			},
			h() {
				i(m, 'href', '#prev'),
					i(m, 'class', 'prev svelte-8o60eg'),
					i(m, 'title', 'previous quote'),
					w(m, 'not-clickable', t[2]),
					i(E, 'href', '#next'),
					i(E, 'class', 'next svelte-8o60eg'),
					i(E, 'title', 'next quote'),
					w(E, 'not-clickable', t[2]),
					i(L, 'class', 'dot-container svelte-8o60eg'),
					i(e, 'class', 'slideshow-container svelte-8o60eg');
			},
			m(a, s) {
				h(a, e, s),
					U.m(e, null),
				...
				x(L, R),
					f(H, L, null),
					(C = !0),
					F || ((G = [q(m, 'click', t[7]), q(E, 'click', t[6])]), (F = !0));
			},
			p(t, [s]) {
				if (
					(32 & s && a(Q, (Q = t[5]))
						? (N(), p(U, 1, 1, I), V(), (U = nt(t)), U.c(), $(U), U.m(e, u))
						: U.p(t, s),
					...
					for (J = T, e = 0; e < J.length; e += 1) {
						...
						K[e]
							? (K[e].p(a, s), $(K[e], 1))
							: ((K[e] = rt(a)), K[e].c(), $(K[e], 1), K[e].m(L, R));
					}
			...
			i(t) {
				if (!C) {
					$(U);
					for (let t = 0; t < J.length; t += 1) $(K[t]);
					$(H.$$.fragment, t), (C = !0);
				}
			},
			o(t) {
...
function ut(t) {
	...
	return {
		c() {
			(e = v($)), (a = b()), (n = s('br')), (c = s('span')), (u = v(m)), (f = b()), this.h();
		},
		l(t) {
			(e = _(t, $)), (a = y(t)), (n = r(t, 'BR', { class: !0 })), (c = r(t, 'SPAN', { class: !0 }));
			var s = o(c);
			(u = _(s, m)), s.forEach(l), (f = y(t)), this.h();
		},
		h() {
			i(n, 'class', 'svelte-1vwij43'), i(c, 'class', 'svelte-1vwij43');
		},
		m(t, s) {
			h(t, e, s), h(t, a, s), h(t, n, s), h(t, c, s), x(c, u), h(t, f, s);
		},
		p(t, a) {
			1 & a && $ !== ($ = t[4] + '') && k(e, $), 1 & a && m !== (m = t[5] + '') && k(u, m);
		},
		d(t) {
		...
		p(t, a) {
			if (3 & a) {
				...
				for (s = t[0], o = 0; o < s.length; o += 1) {
					...
					n[o]
						? (n[o].p(r, a), $(n[o], 1))
						: ((n[o] = ht(r)), n[o].c(), $(n[o], 1), n[o].m(e.parentNode, e));
				}
...
function pt(t) {
	let e, a, u, m, g, v, _, k, w, q, E, j, P, D, N, V, B, S, A, W, C, G;
	return (
		(u = new H({
		...
		})),
		{
			...
			l(t) {
				...
				a = r(s, 'DIV', { class: !0 });
				var n = o(a);
				c(u.$$.fragment, n), n.forEach(l), (m = y(s)), (g = r(s, 'DIV', { class: !0 }));
				var i = o(g);
				c(v.$$.fragment, i), i.forEach(l), (_ = y(s)), (k = r(s, 'DIV', { class: !0 }));
				var h = o(k);
				c(w.$$.fragment, h),
					h.forEach(l),
					s.forEach(l),
				...
				j = r(f, 'DIV', { class: !0 });
				var $ = o(j);
				c(P.$$.fragment, $), $.forEach(l), (D = y(f)), (N = r(f, 'DIV', { class: !0 }));
				var p = o(N);
				c(V.$$.fragment, p),
					p.forEach(l),
					f.forEach(l),
					...
					(S = r(t, 'DIV', { class: !0 }));
				var d = o(S);
				c(A.$$.fragment, d), (W = y(d)), c(C.$$.fragment, d), d.forEach(l), this.h();
			},
			h() {
