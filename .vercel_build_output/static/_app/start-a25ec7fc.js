...
import { L as Y, a as Z } from './chunks/ListItem-800c4c59.js';
function X(t) {
	let e,
		s,
		r = t[1].stack + '';
...
function Q(t) {
	...
	return {
		...
		l(l) {
			...
			var g = p(a);
			(n = f(g, i)), g.forEach(d), (o = y(l)), E && E.l(l), (c = w());
		},
		m(t, i) {
			g(t, e, i), m(e, s), g(t, r, i), g(t, a, i), m(a, n), g(t, o, i), E && E.m(t, i), g(t, c, i);
		},
		p(t, [e]) {
			1 & e && v(s, t[0]),
...
function ct(t) {
	...
	for (let i = 0; i < n.length; i += 1) o = E(o, n[i]);
	e = new t[8]({ props: o });
	let c = t[5] && nt(t);
	return {
		c() {
			b(e.$$.fragment), (s = $()), c && c.c(), (r = w());
		},
		l(t) {
	...
	return {
		...
		h() {
			_(r, 'cx', '25'),
				_(r, 'cy', '25'),
				_(r, 'r', '25'),
				_(r, 'class', 'svelte-1pfy6ud'),
				_(n, 'cx', '12.5'),
				_(n, 'cy', '25'),
				_(n, 'r', '12.5'),
				_(n, 'class', 'svelte-1pfy6ud'),
				_(o, 'cx', '38'),
				_(o, 'cy', '25'),
				_(o, 'r', '12.5'),
				_(o, 'class', 'svelte-1pfy6ud'),
				_(a, 'class', 'svelte-1pfy6ud'),
				_(i, 'cx', '6.5'),
				_(i, 'cy', '25'),
				_(i, 'r', '6.25'),
				_(i, 'class', 'svelte-1pfy6ud'),
				_(l, 'cx', '19'),
				_(l, 'cy', '25'),
				_(l, 'r', '6.25'),
				_(l, 'class', 'svelte-1pfy6ud'),
				_(h, 'cx', '31.5'),
				_(h, 'cy', '25'),
				_(h, 'r', '6.25'),
				_(h, 'class', 'svelte-1pfy6ud'),
				_(f, 'cx', '44'),
				_(f, 'cy', '25'),
				_(f, 'r', '6.25'),
				_(f, 'class', 'svelte-1pfy6ud'),
				_(c, 'class', 'svelte-1pfy6ud'),
				_(s, 'class', 'svelte-1pfy6ud'),
				_(e, 'class', 'logo svelte-1pfy6ud'),
				_(e, 'width', '51'),
				_(e, 'height', '51');
		},
		m(t, u) {
...
function $t(t) {
	let e,
		...
		r = J,
		a = [];
	for (let n = 0; n < r.length; n += 1) a[n] = yt(mt(t, r, n));
	return {
		c() {
			e = l('nav');
		...
		h() {
			_(e, 'class', (s = D(t[4][t[1]]) + ' svelte-1kpu08o'));
		},
		m(t, s) {
			g(t, e, s);
		...
		p(t, n) {
			...
			2 & n && s !== (s = D(t[4][t[1]]) + ' svelte-1kpu08o') && _(e, 'class', s);
		},
		i: x,
		o: x,
		d(t) {
...
function wt(t) {
	...
	return {
		...
		h() {
			_(s, 'class', 'ButtonNav svelte-1kpu08o'),
				_(n, 'class', (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-1kpu08o')),
				_(e, 'class', 'Variante_1 svelte-1kpu08o');
		},
		m(o, l) {
			g(o, e, l), m(e, s), L(r, s, null), m(e, a), m(e, n);
		...
		p(t, e) {
			...
			(!c ||
				(4 & e &&
					o !== (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-1kpu08o'))) &&
				_(n, 'class', o);
		},
		i(t) {
...
function yt(t) {
	...
	return {
		...
		h() {
			_(e, 'href', t[9]), _(e, 'class', 'svelte-1kpu08o'), I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function xt(t) {
	...
	return {
		...
		h() {
			_(e, 'href', t[9]),
				_(e, 'class', 'NavItem svelte-1kpu08o'),
				_(e, 'role', 'navigation'),
				I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
class bt extends o {
	constructor(t) {
		super(), c(this, t, _t, Et, i, { current_page: 0, variante: 1 });
	}
}
function kt(t) {
	let e, s, r, a;
...
function St(t) {
	...
	return (
		...
		})),
		{
			...
			h() {
				_(s, 'class', 'svelte-1wowx06'), _(e, 'class', 'Links svelte-1wowx06');
			},
			m(t, c) {
...
var Pt = Object.freeze({
	...
	default: class extends o {
		constructor(t) {
			super(), c(this, t, jt, Nt, i, {});
		}
	}
});
const Tt = [
		() =>
			pt(() => import('./pages/index.svelte-736e4638.js'), [
				'/_app/pages/index.svelte-736e4638.js',
				'/_app/assets/pages/index.svelte-62dcf162.css',
				'/_app/assets/ListItem.svelte-003bbb65.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid-86dcf0b4.js',
				'/_app/assets/Grid-78a43500.css',
				'/_app/chunks/Header-cc4c0be9.js',
				'/_app/assets/Header-39449bd2.css',
				'/_app/chunks/pages-6818a1c6.js',
				'/_app/chunks/Img-a5b8f450.js',
				'/_app/assets/Img-89ba4149.css',
				'/_app/chunks/index-65311448.js',
				'/_app/chunks/index-78b22dae.js',
				'/_app/chunks/ListItem-800c4c59.js'
			]),
		() =>
			pt(() => import('./pages/philosophy/index.svelte-749d1b5b.js'), [
				'/_app/pages/philosophy/index.svelte-749d1b5b.js',
				'/_app/assets/pages/philosophy/index.svelte-80970421.css',
				'/_app/assets/Tabs.svelte-4592afd0.css',
				'/_app/assets/ListItem.svelte-003bbb65.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid-86dcf0b4.js',
				'/_app/assets/Grid-78a43500.css',
				'/_app/chunks/Header-cc4c0be9.js',
				'/_app/assets/Header-39449bd2.css',
				'/_app/chunks/Tabs-8ddf30b4.js',
				'/_app/chunks/ListItem-800c4c59.js'
			]),
		() =>
			pt(() => import('./pages/prototype/index.svelte-5a4eea42.js'), [
				'/_app/pages/prototype/index.svelte-5a4eea42.js',
				'/_app/assets/pages/prototype/index.svelte-73a97ea7.css',
				'/_app/assets/Tabs.svelte-4592afd0.css',
				'/_app/assets/ListItem.svelte-003bbb65.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid-86dcf0b4.js',
		...
		() =>
			pt(() => import('./pages/artworks/index.svelte-37bdf41b.js'), [
				'/_app/pages/artworks/index.svelte-37bdf41b.js',
				'/_app/assets/pages/artworks/index.svelte-8cb2f83b.css',
				'/_app/assets/ListItem.svelte-003bbb65.css',
				'/_app/assets/Tabs.svelte-4592afd0.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid-86dcf0b4.js',
		...
		() =>
			pt(() => import('./pages/about/index.svelte-fbf39224.js'), [
				'/_app/pages/about/index.svelte-fbf39224.js',
				'/_app/assets/pages/about/index.svelte-9b4120ee.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Header-cc4c0be9.js',
				'/_app/assets/Header-39449bd2.css',
		...
		() =>
			pt(() => import('./pages/lab/index.svelte-09e56a49.js'), [
				'/_app/pages/lab/index.svelte-09e56a49.js',
				'/_app/assets/pages/lab/index.svelte-15cf4683.css',
				'/_app/assets/ListItem.svelte-003bbb65.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid-86dcf0b4.js',
				'/_app/assets/Grid-78a43500.css',
