...
import { L as W } from './chunks/List-340c877d.js';
import { w as J } from './chunks/index-cc16b092.js';
import { p as Y } from './chunks/pages-9b466ab8.js';
function Z(t) {
	let e,
		s,
		r = t[1].stack + '';
...
function X(t) {
	...
	return {
		...
		l(l) {
			...
			var g = p(a);
			(n = d(g, c)), g.forEach(f), (o = w(l)), _ && _.l(l), (i = $());
		},
		m(t, c) {
			g(t, e, c), v(e, s), g(t, r, c), g(t, a, c), v(a, n), g(t, o, c), _ && _.m(t, c), g(t, i, c);
		},
		p(t, [e]) {
			1 & e && m(s, t[0]),
		...
		o: E,
		d(t) {
			t && f(e), t && f(r), t && f(a), t && f(o), _ && _.d(t), t && f(i);
		}
	};
}
function Q(t, e, s) {
...
function et(t) {
	...
	return (
		n && (e = new n(o())),
		{
			...
			m(t, a) {
				e && k(e, t, a), g(t, s, a), (r = !0);
			},
			p(t, r) {
				const i = 16 & r ? L(a, [V(t[4] || {})]) : {};
				if (n !== (n = t[2][1])) {
					if (e) {
						N();
						const t = e;
					...
					n
						? ((e = new n(o())), x(e.$$.fragment), A(e.$$.fragment, 1), k(e, s.parentNode, s))
						: (e = null);
				} else n && e.$set(i);
			},
			i(t) {
...
function ot(t) {
	...
	return {
		...
		m(t, n) {
			k(e, t, n), g(t, s, n), i && i.m(t, n), g(t, r, n), (a = !0);
		},
		p(t, [s]) {
	...
	return {
		...
		l(t) {
			...
			(c = u(y, 'circle', { cx: !0, cy: !0, r: !0, class: !0 }, 1)),
				...
				p(h).forEach(f),
				(d = u(y, 'circle', { cx: !0, cy: !0, r: !0, class: !0 }, 1)),
				p(d).forEach(f),
				y.forEach(f),
				v.forEach(f),
				g.forEach(f),
		...
		h() {
			b(r, 'cx', '25'),
				b(r, 'cy', '25'),
				b(r, 'r', '25'),
				b(r, 'class', 'svelte-1nrtyg0'),
				b(n, 'cx', '12.5'),
				b(n, 'cy', '25'),
				b(n, 'r', '12.5'),
				b(n, 'class', 'svelte-1nrtyg0'),
				b(o, 'cx', '38'),
				b(o, 'cy', '25'),
				b(o, 'r', '12.5'),
				b(o, 'class', 'svelte-1nrtyg0'),
				b(a, 'class', 'svelte-1nrtyg0'),
				b(c, 'cx', '6.5'),
				b(c, 'cy', '25'),
				b(c, 'r', '6.25'),
				b(c, 'class', 'svelte-1nrtyg0'),
				b(l, 'cx', '19'),
				b(l, 'cy', '25'),
				b(l, 'r', '6.25'),
				b(l, 'class', 'svelte-1nrtyg0'),
				b(h, 'cx', '31.5'),
				b(h, 'cy', '25'),
				b(h, 'r', '6.25'),
				b(h, 'class', 'svelte-1nrtyg0'),
				b(d, 'cx', '44'),
				b(d, 'cy', '25'),
				b(d, 'r', '6.25'),
				b(d, 'class', 'svelte-1nrtyg0'),
				b(i, 'class', 'svelte-1nrtyg0'),
				b(s, 'class', 'svelte-1nrtyg0'),
				b(e, 'class', 'logo svelte-1nrtyg0'),
				b(e, 'width', '51'),
				b(e, 'height', '51');
		},
		m(t, u) {
...
function mt(t) {
	let e,
		...
		r = Y,
		a = [];
	for (let n = 0; n < r.length; n += 1) a[n] = $t(gt(t, r, n));
	return {
		c() {
			e = l('nav');
		...
		h() {
			b(e, 'class', (s = D(t[4][t[1]]) + ' svelte-ytq55d'));
		},
		m(t, s) {
			g(t, e, s);
		...
		p(t, n) {
			if (1 & n) {
				...
				for (r = Y, s = 0; s < r.length; s += 1) {
					const o = gt(t, r, s);
					a[s] ? a[s].p(o, n) : ((a[s] = $t(o)), a[s].c(), a[s].m(e, null));
				}
				for (; s < a.length; s += 1) a[s].d(1);
				a.length = r.length;
			}
			2 & n && s !== (s = D(t[4][t[1]]) + ' svelte-ytq55d') && b(e, 'class', s);
		},
		i: E,
		o: E,
		d(t) {
...
function yt(t) {
	...
	let d = Y,
		m = [];
	for (let l = 0; l < d.length; l += 1) m[l] = wt(vt(t, d, l));
	return {
		c() {
			(e = l('div')), (s = l('div')), x(r.$$.fragment), (a = y()), (n = l('nav'));
		...
		l(t) {
			...
			s = u(o, 'DIV', { class: !0 });
			var i = p(s);
			q(r.$$.fragment, i), i.forEach(f), (a = w(o)), (n = u(o, 'NAV', { class: !0 }));
			var c = p(n);
			for (let e = 0; e < m.length; e += 1) m[e].l(c);
			c.forEach(f), o.forEach(f), this.h();
		},
		h() {
			b(s, 'class', 'ButtonNav svelte-ytq55d'),
				b(n, 'class', (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-ytq55d')),
				b(e, 'class', 'Variante_1 svelte-ytq55d');
		},
		m(o, l) {
			g(o, e, l), v(e, s), k(r, s, null), v(e, a), v(e, n);
		...
		p(t, e) {
			...
			(!i ||
				(4 & e && o !== (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-ytq55d'))) &&
				b(n, 'class', o);
		},
		i(t) {
			i || (A(r.$$.fragment, t), (i = !0));
		},
		o(t) {
			R(r.$$.fragment, t), (i = !1);
		},
		d(t) {
			t && f(e), C(r), H(m, t), (c = !1), U(h);
		}
	};
}
function $t(t) {
	...
	return {
		...
		h() {
			b(e, 'href', t[9]), b(e, 'class', 'svelte-ytq55d'), I(e, 'active', t[10] === t[0]);
		},
		m(o, i) {
			g(o, e, i), v(e, s), v(e, r), a || ((n = B(e, 'click', t[6])), (a = !0));
		},
		p(t, s) {
...
function wt(t) {
	...
	return {
		...
		h() {
			b(e, 'href', t[9]),
				b(e, 'class', 'NavItem svelte-ytq55d'),
				b(e, 'role', 'navigation'),
				I(e, 'active', t[10] === t[0]);
		},
		m(o, i) {
...
function xt(t) {
	let e, s, r, a, n, o, i, c, m, $, E, _, x, q, k, L, V, A, R, C, S, M, O, N, P, j, I, B, D;
	return {
		c() {
			(e = l('a')),
				(s = T('svg')),
		...
		l(t) {
			...
			var v = p(i);
			c = u(v, 'svg', { xmlns: !0, viewBox: !0, class: !0 }, 1);
			var y = p(c);
			m = u(y, 'title', { class: !0 }, 1);
			var b = p(m);
			($ = d(b, 'Algunos artículos en Medium')),
				b.forEach(f),
				(E = u(y, 'path', { d: !0, class: !0 }, 1)),
				p(E).forEach(f),
				y.forEach(f),
				v.forEach(f),
				(_ = w(t)),
			...
			var T = p(x);
			q = u(T, 'svg', { xmlns: !0, viewBox: !0, class: !0 }, 1);
			var H = p(q);
			k = u(H, 'title', { class: !0 }, 1);
			var U = p(k);
			(L = d(U, 'Twitter')),
				U.forEach(f),
				(V = u(H, 'path', { d: !0, class: !0 }, 1)),
				p(V).forEach(f),
				H.forEach(f),
				T.forEach(f),
				(A = w(t)),
				(R = u(t, 'A', { href: !0, target: !0, rel: !0, class: !0 }));
			var z = p(R);
			C = u(z, 'svg', { xmlns: !0, viewBox: !0, class: !0 }, 1);
			var K = p(C);
			S = u(K, 'title', { class: !0 }, 1);
			var F = p(S);
			(M = d(F, 'Mi repositorio en Github')),
				F.forEach(f),
				(O = u(K, 'path', { 'fill-rule': !0, 'clip-rule': !0, d: !0, class: !0 }, 1)),
				p(O).forEach(f),
				K.forEach(f),
				z.forEach(f),
				(N = w(t)),
				(P = u(t, 'A', { href: !0, target: !0, rel: !0, class: !0 }));
			var G = p(P);
			j = u(G, 'svg', { xmlns: !0, viewBox: !0, class: !0 }, 1);
			var W = p(j);
		...
		h() {
			b(r, 'class', 'svelte-11q32ii'),
				...
				b(c, 'class', 'svelte-11q32ii'),
				b(i, 'href', 'https://medium.com/@todh'),
				b(i, 'target', '_blank'),
				b(i, 'rel', 'noopener'),
				b(i, 'class', 'svelte-11q32ii'),
				b(k, 'class', 'svelte-11q32ii'),
				b(
					V,
					'd',
				...
				b(V, 'class', 'svelte-11q32ii'),
				b(q, 'xmlns', 'http://www.w3.org/2000/svg'),
				b(q, 'viewBox', '0 0 16 16'),
				b(q, 'class', 'svelte-11q32ii'),
				b(x, 'href', 'https://twitter.com/t0tinspire'),
				b(x, 'target', '_blank'),
				b(x, 'rel', 'noopener'),
				b(x, 'class', 'svelte-11q32ii'),
				b(S, 'class', 'svelte-11q32ii'),
				b(O, 'fill-rule', 'evenodd'),
				b(O, 'clip-rule', 'evenodd'),
				b(
					O,
					'd',
				...
				b(O, 'class', 'svelte-11q32ii'),
				b(C, 'xmlns', 'http://www.w3.org/2000/svg'),
				b(C, 'viewBox', '0 0 16 16'),
				b(C, 'class', 'svelte-11q32ii'),
				b(R, 'href', 'https://github.com/t0t'),
				b(R, 'target', '_blank'),
				b(R, 'rel', 'noopener'),
				b(R, 'class', 'svelte-11q32ii'),
				b(I, 'class', 'svelte-11q32ii'),
				...
				b(D, 'class', 'svelte-11q32ii'),
				b(j, 'xmlns', 'http://www.w3.org/2000/svg'),
				b(j, 'viewBox', '0 0 16 16'),
				b(j, 'class', 'svelte-11q32ii'),
				b(P, 'href', 'https://www.facebook.com/TODH-2139705836275088'),
				b(P, 'target', '_blank'),
				b(P, 'rel', 'noopener'),
				b(P, 'class', 'svelte-11q32ii');
		},
		m(t, l) {
			g(t, e, l),
				v(e, s),
...
function qt(t) {
	...
	return (
		...
		})),
		{
			...
			h() {
				b(s, 'class', 'svelte-11q32ii'), b(e, 'class', 'Links svelte-11q32ii');
			},
			m(t, i) {
				g(t, e, i), v(e, s), v(s, r), v(e, a), k(n, e, null), (o = !0);
			},
			p(t, [e]) {
				const s = {};
		...
		(i = new Vt({})),
		{
			...
			l(t) {
				F('[data-svelte="svelte-1ygbxhz"]', document.head).forEach(f),
					...
					(r = u(t, 'MAIN', {}));
				var e = p(r);
				q(a.$$.fragment, e), (n = w(e)), d && d.l(e), (o = w(e)), q(i.$$.fragment, e), e.forEach(f);
			},
			m(t, e) {
				g(t, s, e),
					g(t, r, e),
			...
			i(t) {
				c || (A(a.$$.fragment, t), A(d, t), A(i.$$.fragment, t), (c = !0));
			},
			o(t) {
				R(a.$$.fragment, t), R(d, t), R(i.$$.fragment, t), (c = !1);
			},
			d(t) {
				t && f(s), t && f(r), C(a), d && d.d(t), C(i);
			}
		}
	);
}
...
var Ct = Object.freeze({
	...
	default: class extends o {
		constructor(t) {
			super(), i(this, t, Rt, At, c, {});
		}
	}
});
const St = [
		() =>
			ut(() => import('./pages/index.svelte-eded0fcb.js'), [
				'/_app/pages/index.svelte-eded0fcb.js',
				'/_app/assets/pages/index.svelte-f36a9c48.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Header-e756daf8.js',
				'/_app/assets/Header-437b8f04.css',
				'/_app/chunks/ListItem-7b7dc3dc.js',
				'/_app/assets/ListItem-6b093b16.css',
				'/_app/chunks/List-340c877d.js',
				'/_app/assets/List-0c8dbd98.css',
				'/_app/chunks/index-65311448.js',
				'/_app/chunks/index-78b22dae.js',
				'/_app/chunks/Img-3bbfc0ef.js',
				'/_app/assets/Img-34ee80a3.css',
				'/_app/chunks/pages-9b466ab8.js'
			]),
		() =>
			ut(() => import('./pages/philosophy/index.svelte-97b1aecc.js'), [
				'/_app/pages/philosophy/index.svelte-97b1aecc.js',
				'/_app/assets/pages/philosophy/index.svelte-42fa8bb7.css',
				'/_app/chunks/index-d91e1ed8.js',
				...
				'/_app/chunks/Header-e756daf8.js',
				'/_app/assets/Header-437b8f04.css',
				'/_app/chunks/Tabs-f3d38449.js',
				'/_app/assets/Tabs-3ef4475f.css',
				'/_app/chunks/List-340c877d.js',
				'/_app/assets/List-0c8dbd98.css'
			]),
		() =>
			ut(() => import('./pages/prototype/index.svelte-ba9cafd6.js'), [
				'/_app/pages/prototype/index.svelte-ba9cafd6.js',
				'/_app/assets/pages/prototype/index.svelte-13629960.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/coverData-76b1c622.js',
				'/_app/chunks/Header-e756daf8.js',
				'/_app/assets/Header-437b8f04.css',
		...
		() =>
			ut(() => import('./pages/artworks/index.svelte-a3c501b8.js'), [
				'/_app/pages/artworks/index.svelte-a3c501b8.js',
				'/_app/assets/pages/artworks/index.svelte-55105341.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/coverData-76b1c622.js',
				'/_app/chunks/Tabs-f3d38449.js',
				'/_app/assets/Tabs-3ef4475f.css',
		...
		() =>
			ut(() => import('./pages/about/index.svelte-3adcd237.js'), [
				'/_app/pages/about/index.svelte-3adcd237.js',
				'/_app/assets/pages/about/index.svelte-36bf3afe.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Header-e756daf8.js',
				'/_app/assets/Header-437b8f04.css',
		...
		() =>
			ut(() => import('./pages/lab/index.svelte-60c5f1da.js'), [
				'/_app/pages/lab/index.svelte-60c5f1da.js',
				'/_app/assets/pages/lab/index.svelte-18b899ff.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/coverData-76b1c622.js',
				'/_app/chunks/Header-e756daf8.js',
				'/_app/assets/Header-437b8f04.css',
	...
	init(t) {
		...
		(this.renderer = t),
			...
			addEventListener('scroll', () => {
				clearTimeout(e),
					(e = setTimeout(() => {
						const t = n(n({}, history.state || {}), { 'sveltekit:scroll': Ot() });
			...
			addEventListener('click', (t) => {
				...
				if (n) {
					...
					history.pushState({}, '', a.href),
						this._navigate(n, s ? Ot() : null, [], a.hash),
						t.preventDefault();
				}
			}),
		...
		if (this.enabled) {
			...
			if (n)
				return (
					...
					this._navigate(n, e ? Ot() : null, r, a.hash)
				);
		}
...
class Bt {
	constructor({ Root: t, layout: e, target: s, session: r, host: a }) {
		(this.Root = t),
			...
			(this.stores = { page: jt({}), navigating: J(null), session: J(r) }),
			(this.$session = null),
			(this.root = null);
		let n = !1;
			...
			for (let s = 0; s < t.length; s += 1) {
				...
				if (
					...
					if (g) {
						...
						if ((g.context && ((i.context = !0), (l = n(n({}, l), g.context))), g.maxage)) {
...
async function Dt({ paths: t, target: e, session: s, host: r, route: a, hydrate: n }) {
	const o = a && new Pt({ base: t.base, routes: Mt }),
		i = new Bt({ Root: ct, layout: Ct, target: e, session: s, host: r });
