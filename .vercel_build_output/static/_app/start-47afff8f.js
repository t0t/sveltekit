...
import { L as W, a as J } from './chunks/ListItem-13a8e652.js';
...
function Q(t) {
	...
	return {
		...
		l(l) {
			e = u(l, 'H1', {});
			var h = p(e);
			(s = d(h, t[0])), h.forEach(f), (r = b(l)), (a = u(l, 'P', {}));
			var g = p(a);
			(n = d(g, i)), g.forEach(f), (o = b(l)), x && x.l(l), (c = y());
		},
		m(t, i) {
			g(t, e, i), m(e, s), g(t, r, i), g(t, a, i), m(a, n), g(t, o, i), x && x.m(t, i), g(t, c, i);
		},
		p(t, [e]) {
			1 & e && v(s, t[0]),
		...
		n && (e = new n(o())),
		{
			...
			p(t, r) {
				...
				if (n !== (n = t[2][1])) {
					...
					n
						? ((e = new n(o())), _(e.$$.fragment), V(e.$$.fragment, 1), k(e, s.parentNode, s))
						: (e = null);
				} else n && e.$set(c);
			},
			i(t) {
...
function ct(t) {
	...
	return {
		...
		l(t) {
			q(e.$$.fragment, t), (s = b(t)), c && c.l(t), (r = y());
		},
		m(t, n) {
			k(e, t, n), g(t, s, n), c && c.m(t, n), g(t, r, n), (a = !0);
		},
		p(t, [s]) {
			const a = 8 & s ? L(n, [j(t[3] || {})]) : {};
...
function it(t, e, s) {
	let { status: r } = e,
		...
		{ props_1: l = null } = e;
	const h = c[0];
	S('__svelte__', n), A(n.page.notify);
	let u = !1,
		p = !1,
		d = null;
	return (
	...
	return {
		...
		h() {
			E(r, 'cx', '25'),
				E(r, 'cy', '25'),
				E(r, 'r', '25'),
				E(r, 'class', 'svelte-iepqu8'),
				E(n, 'cx', '12.5'),
				E(n, 'cy', '25'),
				E(n, 'r', '12.5'),
				E(n, 'class', 'svelte-iepqu8'),
				E(o, 'cx', '38'),
				E(o, 'cy', '25'),
				E(o, 'r', '12.5'),
				E(o, 'class', 'svelte-iepqu8'),
				E(a, 'class', 'svelte-iepqu8'),
				E(i, 'cx', '6.5'),
				E(i, 'cy', '25'),
				E(i, 'r', '6.25'),
				E(i, 'class', 'svelte-iepqu8'),
				E(l, 'cx', '19'),
				E(l, 'cy', '25'),
				E(l, 'r', '6.25'),
				E(l, 'class', 'svelte-iepqu8'),
				E(h, 'cx', '31.5'),
				E(h, 'cy', '25'),
				E(h, 'r', '6.25'),
				E(h, 'class', 'svelte-iepqu8'),
				E(d, 'cx', '44'),
				E(d, 'cy', '25'),
				E(d, 'r', '6.25'),
				E(d, 'class', 'svelte-iepqu8'),
				E(c, 'class', 'svelte-iepqu8'),
				E(s, 'class', 'svelte-iepqu8'),
				E(e, 'class', 'logo svelte-iepqu8'),
				E(e, 'width', '51'),
				E(e, 'height', '51');
		},
		m(t, u) {
...
function $t(t) {
	...
	return {
		...
		h() {
			E(e, 'class', (s = D(t[4][t[1]]) + ' svelte-1q51vo3'));
		},
		m(t, s) {
			g(t, e, s);
		...
		p(t, n) {
			...
			2 & n && s !== (s = D(t[4][t[1]]) + ' svelte-1q51vo3') && E(e, 'class', s);
		},
		i: w,
		o: w,
		d(t) {
...
function yt(t) {
	...
	let d = Z,
		v = [];
	for (let l = 0; l < d.length; l += 1) v[l] = wt(vt(t, d, l));
	return {
		c() {
		...
		l(t) {
			...
			s = u(o, 'DIV', { class: !0 });
			var c = p(s);
			q(r.$$.fragment, c), c.forEach(f), (a = b(o)), (n = u(o, 'NAV', { class: !0 }));
			var i = p(n);
			for (let e = 0; e < v.length; e += 1) v[e].l(i);
			i.forEach(f), o.forEach(f), this.h();
		},
		h() {
			E(s, 'class', 'ButtonNav svelte-1q51vo3'),
				E(n, 'class', (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-1q51vo3')),
				E(e, 'class', 'Variante_1 svelte-1q51vo3');
		},
		m(o, l) {
			g(o, e, l), m(e, s), k(r, s, null), m(e, a), m(e, n);
		...
		p(t, e) {
			...
			(!c ||
				(4 & e &&
					o !== (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-1q51vo3'))) &&
				E(n, 'class', o);
		},
		i(t) {
			c || (V(r.$$.fragment, t), (c = !0));
		},
		o(t) {
			R(r.$$.fragment, t), (c = !1);
		},
		d(t) {
			t && f(e), C(r), H(v, t), (i = !1), U(h);
		}
	};
}
function bt(t) {
	...
	return {
		...
		l(t) {
			...
			var a = p(e);
			(s = d(a, o)), (r = b(a)), a.forEach(f), this.h();
		},
		h() {
			E(e, 'href', t[9]), E(e, 'class', 'svelte-1q51vo3'), I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function wt(t) {
	...
	return {
		...
		h() {
			E(e, 'href', t[9]),
				E(e, 'class', 'NavItem svelte-1q51vo3'),
				E(e, 'role', 'navigation'),
				I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function Rt(t) {
	...
	return (
		...
		})),
		{
			...
			d(t) {
				C(e, t), t && f(s), C(r, t), t && f(a), C(n, t), t && f(o), C(c, t), t && f(i), C(l, t);
			}
		}
	);
}
function Ct(t) {
	...
	return (
		...
		})),
		{
			...
			h() {
				E(s, 'class', 'svelte-dbjobx'), E(e, 'class', 'Links svelte-dbjobx');
			},
			m(t, c) {
				g(t, e, c), m(e, s), m(s, r), m(e, a), k(n, e, null), (o = !0);
			},
			p(t, [e]) {
				const s = {};
		...
		(c = new Mt({})),
		{
			...
			l(t) {
				F('[data-svelte="svelte-1ygbxhz"]', document.head).forEach(f),
					...
					(r = u(t, 'MAIN', {}));
				var e = p(r);
				q(a.$$.fragment, e), (n = b(e)), d && d.l(e), (o = b(e)), q(c.$$.fragment, e), e.forEach(f);
			},
			m(t, e) {
				g(t, s, e),
					g(t, r, e),
			...
			i(t) {
				i || (V(a.$$.fragment, t), V(d, t), V(c.$$.fragment, t), (i = !0));
			},
			o(t) {
				R(a.$$.fragment, t), R(d, t), R(c.$$.fragment, t), (i = !1);
			},
			d(t) {
				t && f(s), t && f(r), C(a), d && d.d(t), C(c);
			}
		}
	);
}
...
const Tt = [
		() =>
			pt(() => import('./pages/index.svelte-ee245155.js'), [
				'/_app/pages/index.svelte-ee245155.js',
				'/_app/assets/pages/index.svelte-5fb7fd0f.css',
				'/_app/assets/Blockquote.svelte-568fbc33.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-1b56dd60.js',
				'/_app/assets/Grid.svelte-99db7dae.css',
				'/_app/chunks/Header-bbb40db3.js',
				'/_app/assets/Header-575f4873.css',
				'/_app/chunks/pages-cee8d843.js',
				'/_app/chunks/ListItem-13a8e652.js',
				'/_app/assets/ListItem-185dc602.css',
				'/_app/chunks/Blockquote-643c6c00.js',
				'/_app/chunks/index-65311448.js',
				'/_app/chunks/index-78b22dae.js',
				'/_app/chunks/Img-1aaa5537.js',
				'/_app/assets/Img-a3eefe65.css'
			]),
		() =>
			pt(() => import('./pages/philosophy/index.svelte-df23c288.js'), [
				'/_app/pages/philosophy/index.svelte-df23c288.js',
				'/_app/assets/pages/philosophy/index.svelte-5c2c5f9e.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-1b56dd60.js',
				'/_app/assets/Grid.svelte-99db7dae.css',
				'/_app/chunks/Header-bbb40db3.js',
				...
				'/_app/chunks/Section-18758c52.js',
				'/_app/chunks/Tabs-b9f98100.js',
				'/_app/assets/Tabs-4fc77da1.css',
				'/_app/chunks/ListItem-13a8e652.js',
				'/_app/assets/ListItem-185dc602.css',
				'/_app/chunks/Img-1aaa5537.js',
				'/_app/assets/Img-a3eefe65.css'
		...
		() =>
			pt(() => import('./pages/prototype/index.svelte-abbb4ac6.js'), [
				'/_app/pages/prototype/index.svelte-abbb4ac6.js',
				'/_app/assets/pages/prototype/index.svelte-28936974.css',
				'/_app/assets/Blockquote.svelte-568fbc33.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-1b56dd60.js',
				'/_app/assets/Grid.svelte-99db7dae.css',
		...
		() =>
			pt(() => import('./pages/artworks/index.svelte-99648a2a.js'), [
				'/_app/pages/artworks/index.svelte-99648a2a.js',
				'/_app/assets/pages/artworks/index.svelte-4e185ef7.css',
				'/_app/assets/Blockquote.svelte-568fbc33.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-1b56dd60.js',
				'/_app/assets/Grid.svelte-99db7dae.css',
		...
		() =>
			pt(() => import('./pages/about/index.svelte-9ec51232.js'), [
				'/_app/pages/about/index.svelte-9ec51232.js',
				'/_app/assets/pages/about/index.svelte-b17c2cec.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Section-18758c52.js',
				'/_app/chunks/Header-bbb40db3.js',
				'/_app/assets/Header-575f4873.css',
		...
		() =>
			pt(() => import('./pages/lab/index.svelte-318c0f9c.js'), [
				'/_app/pages/lab/index.svelte-318c0f9c.js',
				'/_app/assets/pages/lab/index.svelte-06a6b30b.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-1b56dd60.js',
				'/_app/assets/Grid.svelte-99db7dae.css',
				'/_app/chunks/Header-bbb40db3.js',
...
async function Gt({ paths: t, target: e, session: s, host: r, route: a, hydrate: n }) {
	const o = a && new Ht({ base: t.base, routes: It }),
		c = new Ft({ Root: lt, layout: Pt, target: e, session: s, host: r });
