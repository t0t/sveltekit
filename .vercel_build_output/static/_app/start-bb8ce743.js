...
import { L as Y, a as Z } from './chunks/ListItem-91cb1752.js';
function X(t) {
	let e,
		s,
		r = t[1].stack + '';
...
function Q(t) {
	...
	return {
		...
		l(i) {
			...
			var g = p(a);
			(n = f(g, l)), g.forEach(d), (o = w(i)), x && x.l(i), (c = y());
		},
		m(t, l) {
	...
	return {
		...
		h() {
			E(r, 'cx', '25'),
				E(r, 'cy', '25'),
				E(r, 'r', '25'),
				E(r, 'class', 'svelte-7hu05h'),
				E(n, 'cx', '12.5'),
				E(n, 'cy', '25'),
				E(n, 'r', '12.5'),
				E(n, 'class', 'svelte-7hu05h'),
				E(o, 'cx', '38'),
				E(o, 'cy', '25'),
				E(o, 'r', '12.5'),
				E(o, 'class', 'svelte-7hu05h'),
				E(a, 'class', 'svelte-7hu05h'),
				E(l, 'cx', '6.5'),
				E(l, 'cy', '25'),
				E(l, 'r', '6.25'),
				E(l, 'class', 'svelte-7hu05h'),
				E(i, 'cx', '19'),
				E(i, 'cy', '25'),
				E(i, 'r', '6.25'),
				E(i, 'class', 'svelte-7hu05h'),
				E(h, 'cx', '31.5'),
				E(h, 'cy', '25'),
				E(h, 'r', '6.25'),
				E(h, 'class', 'svelte-7hu05h'),
				E(f, 'cx', '44'),
				E(f, 'cy', '25'),
				E(f, 'r', '6.25'),
				E(f, 'class', 'svelte-7hu05h'),
				E(c, 'class', 'svelte-7hu05h'),
				E(s, 'class', 'svelte-7hu05h'),
				E(e, 'class', 'logo svelte-7hu05h'),
				E(e, 'width', '51'),
				E(e, 'height', '51');
		},
		m(t, u) {
...
function $t(t) {
	...
	return {
		...
		h() {
			E(e, 'class', (s = D(t[4][t[1]]) + ' svelte-1h90iqo'));
		},
		m(t, s) {
			g(t, e, s);
		...
		p(t, n) {
			...
			2 & n && s !== (s = D(t[4][t[1]]) + ' svelte-1h90iqo') && E(e, 'class', s);
		},
		i: b,
		o: b,
		d(t) {
...
function yt(t) {
	...
	let f = J,
		v = [];
	for (let i = 0; i < f.length; i += 1) v[i] = bt(vt(t, f, i));
	return {
		c() {
		...
		h() {
			E(s, 'class', 'ButtonNav svelte-1h90iqo'),
				E(n, 'class', (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-1h90iqo')),
				E(e, 'class', 'Variante_1 svelte-1h90iqo');
		},
		m(o, i) {
			g(o, e, i), m(e, s), q(r, s, null), m(e, a), m(e, n);
		...
		p(t, e) {
			...
			(!c ||
				(4 & e &&
					o !== (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-1h90iqo'))) &&
				E(n, 'class', o);
		},
		i(t) {
...
function wt(t) {
	...
	return {
		...
		h() {
			E(e, 'href', t[9]), E(e, 'class', 'svelte-1h90iqo'), I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function bt(t) {
	...
	return {
		...
		h() {
			E(e, 'href', t[9]),
				E(e, 'class', 'NavItem svelte-1h90iqo'),
				E(e, 'role', 'navigation'),
				I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function St(t) {
	...
	return (
		...
		})),
		{
			...
			h() {
				E(s, 'class', 'svelte-1l1vboa'), E(e, 'class', 'Links svelte-1l1vboa');
			},
			m(t, c) {
...
const Tt = [
		() =>
			pt(() => import('./pages/index.svelte-4e650a8a.js'), [
				'/_app/pages/index.svelte-4e650a8a.js',
				'/_app/assets/pages/index.svelte-b2fae80b.css',
				'/_app/assets/ListItem.svelte-4a158a04.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-81f2d089.js',
				'/_app/assets/Grid.svelte-1a401501.css',
				'/_app/chunks/Header-3d35273a.js',
				'/_app/assets/Header-40718043.css',
				'/_app/chunks/pages-6818a1c6.js',
				'/_app/chunks/Grid-11b84c17.js',
				'/_app/chunks/Blockquote-e9c576c6.js',
				'/_app/assets/Blockquote-a44b7971.css',
				'/_app/chunks/index-65311448.js',
				'/_app/chunks/index-78b22dae.js',
				'/_app/chunks/Img-8391a33a.js',
				'/_app/assets/Img-029d5684.css',
				'/_app/chunks/ListItem-91cb1752.js'
			]),
		() =>
			pt(() => import('./pages/philosophy/index.svelte-65b4db08.js'), [
				'/_app/pages/philosophy/index.svelte-65b4db08.js',
				'/_app/assets/pages/philosophy/index.svelte-d444c8c4.css',
				'/_app/assets/Tabs.svelte-9b8c7c0f.css',
				'/_app/assets/ListItem.svelte-4a158a04.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-81f2d089.js',
				'/_app/assets/Grid.svelte-1a401501.css',
		...
		() =>
			pt(() => import('./pages/prototype/index.svelte-890be17e.js'), [
				'/_app/pages/prototype/index.svelte-890be17e.js',
				'/_app/assets/pages/prototype/index.svelte-14dd509c.css',
				'/_app/assets/Tabs.svelte-9b8c7c0f.css',
				'/_app/assets/ListItem.svelte-4a158a04.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-81f2d089.js',
		...
		() =>
			pt(() => import('./pages/artworks/index.svelte-36f5c378.js'), [
				'/_app/pages/artworks/index.svelte-36f5c378.js',
				'/_app/assets/pages/artworks/index.svelte-0092e74b.css',
				'/_app/assets/ListItem.svelte-4a158a04.css',
				'/_app/assets/Tabs.svelte-9b8c7c0f.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-81f2d089.js',
		...
		() =>
			pt(() => import('./pages/about/index.svelte-55b63739.js'), [
				'/_app/pages/about/index.svelte-55b63739.js',
				'/_app/assets/pages/about/index.svelte-dda976cd.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Header-3d35273a.js',
				'/_app/assets/Header-40718043.css',
		...
		() =>
			pt(() => import('./pages/lab/index.svelte-ea5d1aae.js'), [
				'/_app/pages/lab/index.svelte-ea5d1aae.js',
				'/_app/assets/pages/lab/index.svelte-292a293e.css',
				'/_app/assets/ListItem.svelte-4a158a04.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-81f2d089.js',
				'/_app/assets/Grid.svelte-1a401501.css',
