...
import { L as W, a as J } from './chunks/ListItem-cf78d2b1.js';
	...
	return {
		...
		h() {
			E(r, 'cx', '25'),
				E(r, 'cy', '25'),
				E(r, 'r', '25'),
				E(r, 'class', 'svelte-11b7p3d'),
				E(n, 'cx', '12.5'),
				E(n, 'cy', '25'),
				E(n, 'r', '12.5'),
				E(n, 'class', 'svelte-11b7p3d'),
				E(o, 'cx', '38'),
				E(o, 'cy', '25'),
				E(o, 'r', '12.5'),
				E(o, 'class', 'svelte-11b7p3d'),
				E(a, 'class', 'svelte-11b7p3d'),
				E(l, 'cx', '6.5'),
				E(l, 'cy', '25'),
				E(l, 'r', '6.25'),
				E(l, 'class', 'svelte-11b7p3d'),
				E(i, 'cx', '19'),
				E(i, 'cy', '25'),
				E(i, 'r', '6.25'),
				E(i, 'class', 'svelte-11b7p3d'),
				E(h, 'cx', '31.5'),
				E(h, 'cy', '25'),
				E(h, 'r', '6.25'),
				E(h, 'class', 'svelte-11b7p3d'),
				E(d, 'cx', '44'),
				E(d, 'cy', '25'),
				E(d, 'r', '6.25'),
				E(d, 'class', 'svelte-11b7p3d'),
				E(c, 'class', 'svelte-11b7p3d'),
				E(s, 'class', 'svelte-11b7p3d'),
				E(e, 'class', 'logo svelte-11b7p3d'),
				E(e, 'width', '51'),
				E(e, 'height', '51');
		},
		m(t, u) {
...
function $t(t) {
	...
	return {
		...
		h() {
			E(e, 'class', (s = D(t[4][t[1]]) + ' svelte-tremiu'));
		},
		m(t, s) {
			m(t, e, s);
		...
		p(t, n) {
			...
			2 & n && s !== (s = D(t[4][t[1]]) + ' svelte-tremiu') && E(e, 'class', s);
		},
		i: b,
		o: b,
		d(t) {
...
function yt(t) {
	...
	return {
		...
		h() {
			E(s, 'class', 'ButtonNav svelte-tremiu'),
				E(n, 'class', (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-tremiu')),
				E(e, 'class', 'Variante_1 svelte-tremiu');
		},
		m(o, i) {
		...
		p(t, e) {
			...
			(!c ||
				(4 & e && o !== (o = D(t[2] ? 'MainNav MainNavVisible' : 'MainNav') + ' svelte-tremiu'))) &&
				E(n, 'class', o);
		},
		i(t) {
...
function wt(t) {
	...
	return {
		...
		h() {
			E(e, 'href', t[9]), E(e, 'class', 'svelte-tremiu'), I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function bt(t) {
	...
	return {
		...
		h() {
			E(e, 'href', t[9]),
				E(e, 'class', 'NavItem svelte-tremiu'),
				E(e, 'role', 'navigation'),
				I(e, 'active', t[10] === t[0]);
		},
		m(o, c) {
...
function St(t) {
	...
	return (
		...
		})),
		{
			...
			h() {
				E(s, 'class', 'svelte-1g05ml8'), E(e, 'class', 'Links svelte-1g05ml8');
			},
			m(t, c) {
...
const jt = [
		() =>
			pt(() => import('./pages/index.svelte-61d27a1d.js'), [
				'/_app/pages/index.svelte-61d27a1d.js',
				'/_app/assets/pages/index.svelte-a4699736.css',
				'/_app/assets/Blockquote.svelte-3a62d979.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-916f7747.js',
				'/_app/assets/Grid.svelte-5f7e4d4d.css',
				'/_app/chunks/Header-cd15ff25.js',
				'/_app/assets/Header-3d348a02.css',
				'/_app/chunks/pages-cee8d843.js',
				'/_app/chunks/ListItem-cf78d2b1.js',
				'/_app/assets/ListItem-befa2c37.css',
				'/_app/chunks/Blockquote-779c1cb4.js',
				'/_app/chunks/index-65311448.js',
				'/_app/chunks/index-78b22dae.js',
				'/_app/chunks/Img-fdbb3f27.js',
				'/_app/assets/Img-8d9ed01d.css'
			]),
		() =>
			pt(() => import('./pages/philosophy/index.svelte-9fb5f1a9.js'), [
				'/_app/pages/philosophy/index.svelte-9fb5f1a9.js',
				'/_app/assets/pages/philosophy/index.svelte-c1dc1b76.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-916f7747.js',
				'/_app/assets/Grid.svelte-5f7e4d4d.css',
				'/_app/chunks/Header-cd15ff25.js',
				...
				'/_app/chunks/Section-ef966e09.js',
				'/_app/chunks/Tabs-c8192f1e.js',
				'/_app/assets/Tabs-c01383d0.css',
				'/_app/chunks/ListItem-cf78d2b1.js',
				'/_app/assets/ListItem-befa2c37.css',
				'/_app/chunks/Img-fdbb3f27.js',
				'/_app/assets/Img-8d9ed01d.css'
		...
		() =>
			pt(() => import('./pages/prototype/index.svelte-0c3af0c9.js'), [
				'/_app/pages/prototype/index.svelte-0c3af0c9.js',
				'/_app/assets/pages/prototype/index.svelte-d11c8728.css',
				'/_app/assets/Blockquote.svelte-3a62d979.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-916f7747.js',
				'/_app/assets/Grid.svelte-5f7e4d4d.css',
		...
		() =>
			pt(() => import('./pages/artworks/index.svelte-d2804182.js'), [
				'/_app/pages/artworks/index.svelte-d2804182.js',
				'/_app/assets/pages/artworks/index.svelte-83494300.css',
				'/_app/assets/Blockquote.svelte-3a62d979.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-916f7747.js',
				'/_app/assets/Grid.svelte-5f7e4d4d.css',
		...
		() =>
			pt(() => import('./pages/about/index.svelte-74c23272.js'), [
				'/_app/pages/about/index.svelte-74c23272.js',
				'/_app/assets/pages/about/index.svelte-34ccebeb.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Section-ef966e09.js',
				'/_app/chunks/Header-cd15ff25.js',
				'/_app/assets/Header-3d348a02.css',
		...
		() =>
			pt(() => import('./pages/lab/index.svelte-a8ef5bcc.js'), [
				'/_app/pages/lab/index.svelte-a8ef5bcc.js',
				'/_app/assets/pages/lab/index.svelte-deba534f.css',
				'/_app/chunks/index-d91e1ed8.js',
				'/_app/chunks/Grid.svelte-916f7747.js',
				'/_app/assets/Grid.svelte-5f7e4d4d.css',
				'/_app/chunks/Header-cd15ff25.js',
